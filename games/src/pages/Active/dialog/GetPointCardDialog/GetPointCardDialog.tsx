      ...
      <div className={css.card}>
        ...
        {parent ? (
          <Item
            ...
            label={`@${parent}'s team`}
            text={
              "Congratulations! Your captain's team has triumphed by completing the group goal, and they've just snagged the exciting reward scorecard reward! Keep up the great teamwork!"
            }
          />
        ) : (
          <></>
