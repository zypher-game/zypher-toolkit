...
export const TransactionsCount: Record<ChainId, string> = {
  ...
  // v1 https://lineascan.build/address/0xb5eE5a405eE2B27810Ca8d13eD80F16798208327  180
  // v0 https://lineascan.build/address/0xb29cAa2cB1fEb7f4cCaa9Dd9B8Ad2022EaCa6EC3 16696
  [ChainId.LineaMainnet]: 16696 + 365 + '',
  // v0 42161 0x2e6190c90ca9aFc4D39c02b1E680Fb7183fA4a83
  // https://arbiscan.io/address/0x2e6190c90ca9aFc4D39c02b1E680Fb7183fA4a83
  [ChainId.Arbitrum]: '4736',
  ...
  [ChainId.MantaPacificMainnet]: '23579',
  ...
  [ChainId.ScrollSepoliaTestnet]: '396',
  ...
  [ChainId.MantleTestnet]: '0',
  // https://combotrace.nodereal.io/address/0x0868259302676544DD0B8c8d3a1A263B90eb753D
  [ChainId.Combo]: '8',
  [ChainId.Sepolia]: '0',
  [ChainId.B2]: '0',
  [ChainId.B2Testnet]: '0',
  [ChainId.ZytronLineaMain]: '0',
  [ChainId.ZytronLineaSepoliaTestnet]: '0',
  [ChainId.ZytronB2Testnet]: '0',
  [ChainId.Taiko]: '0',
  // https://zypher-2717465680371000-1.sagaexplorer.io/address/0x39e931a97f7B869C9e7B30245a9972AC9265DCE7
...
export const monsterGraphqlApiUrl: Partial<Record<ChainId, string>> = {
  ...
  [ChainId.ZytronLineaMain]: 'https://arb-goerli-graph.zypher.game/subgraphs/name/arb/bingo'
}
