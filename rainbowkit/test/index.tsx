...
export function renderWithProviders(
  ...
  const account = privateKeyToAccount('0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80') // first anvil pk
  ...
  return render(component, {
    wrapper: ({ children }) => (
      <WagmiConfig config={wagmiConfig}>
        <RainbowKitProvider chains={chains} {...options?.props}>
          <h1>ddd</h1>
        </RainbowKitProvider>
      </WagmiConfig>
    )
