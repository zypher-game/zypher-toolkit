...
import { ModalSizeContext, ModalSizeOptions, ModalSizes } from './ModalSizeContext'
import { RainbowKitChain, RainbowKitChainProvider } from './RainbowKitChainContext'
  ...
  return (
    <RainbowKitChainProvider chains={chains} initialChain={initialChain}>
      <CoolModeContext.Provider value={coolMode}>
        <ModalSizeContext.Provider value={isSmallScreen ? ModalSizeOptions.COMPACT : modalSize}>
