...
import { mapResponsiveValue, normalizeResponsiveValue, ResponsiveValue } from '../../css/sprinkles.css'
                ...
                {!unsupportedChain && (
                  ...
                  >
                    {account.displayBalance && (
                      <Box display={mapResponsiveValue(showBalance, value => (value ? 'block' : 'none'))} padding="8" paddingLeft="12">
                        {account.displayBalance}
                      </Box>
                    )}
                    <Box
                    ...
                    >
                      <Box alignItems="center" display="flex" gap="6" height="24">
                        <Box display={mapResponsiveValue(accountStatus, value => (value === 'full' || value === 'avatar' ? 'block' : 'none'))}>
                          <Avatar address={account.address} imageUrl={account.ensAvatar} loading={account.hasPendingTransactions} size={24} />
                        </Box>

                        <Box alignItems="center" display="flex" gap="6">
                          <Box display={mapResponsiveValue(accountStatus, value => (value === 'full' || value === 'address' ? 'block' : 'none'))}>
                            {account.displayName}
                          </Box>
                          <DropdownIcon />
                        </Box>
