...
import { IBingoVersion, preStaticUrl, txStatus, useAaWallet, useResetRecoilState, useSetRecoilState } from '@ui/src'
...
import { gameRoomState, startGameStep } from '@/pages/state/state'
