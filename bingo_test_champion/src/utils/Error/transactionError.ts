...
export const TX_ERROR_PATTERNS: Record<TransactionErrorReason, { message?: string; code?: number | string; name?: string }[]> = {
  ...
  [TransactionErrorReason.WalletSetup]: [
    ...
    {
      message: "Failed to execute 'requestDevice' on 'HID': Must be handling a user gesture to show a permission request."
    },
    {
