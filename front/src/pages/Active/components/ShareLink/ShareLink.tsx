import { ActivePixelButtonColor, IPixelButtonTheme, LoadingButton, preStaticUrl, sleep, SvgComponent, useActiveWeb3React } from '@ui/src'
...
const ShareLink = memo(
  ({ css, preWidth, nextWidth, pixel_styled }: { preWidth: string; nextWidth: string; css: any; pixel_styled: IPixelButtonTheme }) => {
