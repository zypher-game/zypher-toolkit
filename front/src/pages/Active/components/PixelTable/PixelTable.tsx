...
import { ActivePixelCard, IPixelProps, PixelBorderCard } from '@UI/src/'
...
export const PixelTableBorder = memo(
  ({ header_children, body_children, pixel_height, classNameHeader, backgroundColor, headerBackgroundColor, borderColor, width }: IProps) => {
    return (
      <PixelBorderCard
