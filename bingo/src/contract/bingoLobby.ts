...
export const getBingoLobbyAddress = ({
  bingoVersion,
  chainId,
}: {
  bingoVersion: IBingoVersion;
  ...
  return bingoVersion === IBingoVersion.v1
    ? zkBingo(chainId, IContractName.Lobby)
    : zkBingoV0(chainId, IContractName.Lobby);
};
