...
const MonsterIcon: FC<IMonsterIcon> = memo(({ hasMonsterNft }: IMonsterIcon) => {
  ...
  return (
    <>
      <img onClick={showNftRule} src={preStaticUrl + `/img/profile/monster_nft.svg`} alt="level" className={css.levelImg} />
      <MonsterNftDialog />
    </>
  )
}, isEqual)
