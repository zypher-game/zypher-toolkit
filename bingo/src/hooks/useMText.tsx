import { ChainId, preStaticUrl, useActiveWeb3React } from '@zypher-game/toolkit/ui'
...
export const GetGameListBoxImg = memo(() => {
  ...
  if (
    chainId &&
    (localpath === ILocalPathUrl.MANTA || localpath === ILocalPathUrl.COMBO || localpath === ILocalPathUrl.MANTLE || localpath === ILocalPathUrl.Hypr)
  ) {
    return <ImgStyled src={preStaticUrl + `/img/bingo/beta/box_${getChainNameText(chainId, { isLowcase: true })}.png`} />
  }
