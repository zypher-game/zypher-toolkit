...
var PcUserInfo = react_1.memo(function (_a) {
  var _b;
  var connectName = _a.connectName,
    connectIcon = _a.connectIcon,
    account = _a.account,
    chainId = _a.chainId,
    cancel = _a.cancel;
    ...
    react_1["default"].createElement(
      ...
      react_1["default"].createElement(
        ...
        react_1["default"].createElement(
          ...
          tool_1.getShortenAddress(account)
        ),
        react_1["default"].createElement(
          "span",
          {
            onClick: function () {
              return copy_1["default"](account);
            },
          },
        ...
        config.BlockExplorerUrls[chainId] &&
          react_1["default"].createElement(
            ...
            {
              href:
                ((_b = config.BlockExplorerUrls[chainId]) !== null &&
                _b !== void 0
                  ? _b
                  : [0]) +
                "/address/" +
...
exports.DisconnectBtn = react_1.memo(function (_a) {
  ...
  return react_1["default"].createElement(
    "p",
    { className: "pc_user_disconnect_btn", onClick: cancel },
    "Disconnect"
  );
}, lodash_1.isEqual);
