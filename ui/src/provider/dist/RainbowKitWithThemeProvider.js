...
var RainbowKitWithThemeProvider = function (_a) {
    ...
    return (react_1["default"].createElement(wagmi_1.WagmiConfig, { config: rainbow_1.wagmiConfig },
        react_1["default"].createElement(rainbowkit_1.RainbowKitProvider, { chains: rainbow_1.chains, appInfo: constant_1.appInfo, theme: computedTheme }, children)));
};
