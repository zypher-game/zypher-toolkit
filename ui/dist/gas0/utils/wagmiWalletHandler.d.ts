...
export declare class WagmiWalletHandler {
    ...
    aa?: Iaa;
    constructor(walletClient: NonNullable<GetWalletClientResult>, gas0Balance: string, configApi: IGas0ApiConfig);
    ...
    getAAWalletClient(): {
        ...
        signTransaction: <TChainOverride_3 extends Chain | undefined>(args: import("viem/dist/types/actions/wallet/signTransaction").SignTransactionParameters<import("@wagmi/chains").Chain, Account, TChainOverride_3>) => Promise<`0x${string}`>;
...
export declare const gas0WalletCreateAndApprove: (owner: Address, api: string, isFree: boolean) => Promise<any>;
