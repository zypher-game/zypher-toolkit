...
export declare const Box: React.ForwardRefExoticComponent<{
    ...
    readonly height?: "1" | "2" | "4" | "8" | "9" | "12" | "max" | "30" | "24" | "60" | "20" | "28" | "32" | "36" | "34" | "40" | "48" | "44" | "54" | "200" | "full" | undefined;
    ...
    readonly maxWidth?: "1" | "2" | "4" | "8" | "9" | "12" | "max" | "30" | "24" | "60" | "20" | "28" | "32" | "36" | "34" | "40" | "48" | "44" | "54" | "200" | "full" | undefined;
    readonly minWidth?: "1" | "2" | "4" | "8" | "9" | "12" | "max" | "30" | "24" | "60" | "20" | "28" | "32" | "36" | "34" | "40" | "48" | "44" | "54" | "200" | "full" | undefined;
    ...
    readonly paddingRight?: "10" | "0" | "1" | "2" | "3" | "4" | "5" | "6" | "8" | "12" | "14" | "16" | "18" | "24" | "20" | "28" | "32" | "36" | "64" | "44" | "-1" | undefined;
    readonly paddingTop?: "10" | "0" | "1" | "2" | "3" | "4" | "5" | "6" | "8" | "12" | "14" | "16" | "18" | "24" | "20" | "28" | "32" | "36" | "64" | "44" | "-1" | undefined;
    readonly position?: "fixed" | "absolute" | "relative" | undefined;
    readonly right?: "0" | undefined;
    readonly transition?: "transform" | "default" | undefined;
    readonly userSelect?: "none" | undefined;
    readonly width?: "1" | "2" | "4" | "8" | "9" | "12" | "max" | "30" | "24" | "60" | "20" | "28" | "32" | "36" | "34" | "40" | "48" | "44" | "54" | "200" | "full" | undefined;
    ...
    marginY?: "10" | "0" | "1" | "2" | "3" | "4" | "5" | "6" | "8" | "12" | "14" | "16" | "18" | "24" | "20" | "28" | "32" | "36" | "64" | "44" | "-1" | undefined;
    padding?: "10" | "0" | "1" | "2" | "3" | "4" | "5" | "6" | "8" | "12" | "14" | "16" | "18" | "24" | "20" | "28" | "32" | "36" | "64" | "44" | "-1" | undefined;
    paddingX?: "10" | "0" | "1" | "2" | "3" | "4" | "5" | "6" | "8" | "12" | "14" | "16" | "18" | "24" | "20" | "28" | "32" | "36" | "64" | "44" | "-1" | undefined;
    paddingY?: "10" | "0" | "1" | "2" | "3" | "4" | "5" | "6" | "8" | "12" | "14" | "16" | "18" | "24" | "20" | "28" | "32" | "36" | "64" | "44" | "-1" | undefined;
} & {
