...
var ListWithMotion = (props) => {
  ...
  return /* @__PURE__ */ React.createElement(AnimatePresence, null, /* @__PURE__ */ React.createElement(motion.ul, {
    className: parentClassName,
    variants: containerVariants,
    initial: "hidden",
    animate: "visible"
  }, data.map((item, index) => /* @__PURE__ */ React.createElement(motion.li, {
    key: `${index}`,
    className: itemClassName,
    variants: itemVariants
  }, renderItem(item)))));
};
var ListWithMotion_default = memo(ListWithMotion);
...
import React2, { memo as memo2, useEffect as useEffect6, useState as useState5 } from "react";
var SvgComponent = memo2(({ src: src6, className, ...rest }) => {
  return src6.endsWith(".svg") ? /* @__PURE__ */ React2.createElement(Svg, {
    src: src6,
    className,
    ...rest
...
var Svg = memo2(({ src: src6, className, ...rest }) => {
  ...
  useEffect6(() => {
    (async () => {
      try {
        ...
        if (svgElement) {
          const Component = () => /* @__PURE__ */ React2.createElement("span", {
  ...
  return svgContent || /* @__PURE__ */ React2.createElement(React2.Fragment, null);
});
var SvgComponent_default = SvgComponent;

// src/components/icons/index.tsx
var Icon = (props) => {
  return /* @__PURE__ */ React3.createElement(SvgComponent_default, {
...
var useGetUserInfo = () => {
  const getUserInfo = useCallback4(
...
import { atom as atom6 } from "recoil";
var connectorState = atom6({
  key: "connectorState",
  default: {
    chainId: null,
    networkError: null
...
var walletModalOpenState = atom6({
  key: "walletModalOpenState",
  default: false
});
var ChainSelector = atom6({
  key: "ChainSelector",
  default: false
});
var refreshBalanceState = atom6({
  key: "refreshBalance",
  default: "0"
});
var refreshAvatarState = atom6({
  key: "refreshAvatar",
  default: "0"
});
var pointsDialogState = atom6({
  key: "pointsDialog",
  default: false,
  effects_UNSTABLE: [localStorageEffect("pointsDialog")]
});
var pointsAnimState = atom6({
  key: "pointsAnim",
  default: false
});
var pointsAnimNumState = atom6({
  key: "pointsAnimNum",
  default: 0
});
var pointsWarnState = atom6({
  key: "pointsWarn",
  default: 0
});
var hidePointsWarnState = atom6({
  key: "hidePointsWarn",
  default: false,
  effects_UNSTABLE: [localStorageEffect("hidePointsWarn")]
});
var pointsRuleDialogState = atom6({
  key: "pointsRuleDialog",
  default: false
});
var accountInfoDialogState = atom6({
  key: "accountInfoDialog",
  default: false
});
var showBigState = atom6({
  key: "showBigState",
  default: false
});
var showMiddleState = atom6({
  key: "showMiddleState",
  default: false
});
var linkToBetaDialogState = atom6({
  key: "linkToBetaDialog",
  default: false
});
var linkToBetaDialogChainIdState = atom6({
  key: "linkToBetaDialogChainIdState",
  default: void 0
});
var nativeBalanceState = atom6({
  key: "nativeBalance",
  default: 0,
  effects_UNSTABLE: [localStorageEffect("nativeBalance")]
});
var pointsBalanceState = atom6({
  key: "pointsBalance",
  default: 0,
...
import React16, { memo as memo13, useCallback as useCallback12, useEffect as useEffect11, useState as useState13 } from "react";
...
import { useCallback as useCallback5, useContext, useEffect as useEffect8, useState as useState7 } from "react";

// src/provider/IsMobileProvider.tsx
import React5, { createContext, memo as memo3, useEffect as useEffect7 } from "react";
import { atom as atom7, useRecoilState as useRecoilState2 } from "recoil";
var isW768State = atom7({
  key: "isW768State",
  default: false,
  effects_UNSTABLE: [localStorageEffect("isW768State")]
});
var isWMdState = atom7({
  key: "isWMdState",
  default: false,
  effects_UNSTABLE: [localStorageEffect("isWMdState")]
});
var isW1100State = atom7({
  key: "isW1100State",
  default: false,
  effects_UNSTABLE: [localStorageEffect("isW1100State")]
});
var isW1220State = atom7({
  key: "isW1220State",
  default: false,
...
var IsW768Provider = memo3(({ children }) => {
  ...
  return /* @__PURE__ */ React5.createElement(IsW768Context.Provider, {
    value: isMobile2
  }, children);
});
var IsMdProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ React5.createElement(IsW950Context.Provider, {
    value: isWMd
  }, children);
};
var IsW1100Provider = ({ children }) => {
  ...
  return /* @__PURE__ */ React5.createElement(IsW1100Context.Provider, {
    value: isW1100
  }, children);
};
var IsW1220Provider = ({ children }) => {
  ...
  return /* @__PURE__ */ React5.createElement(IsW1220Context.Provider, {
    value: isW1220
  }, children);
};
...
import React9, { memo as memo7, useCallback as useCallback11 } from "react";

// src/hooks/useCurrentLanguage.ts
import i18n from "i18next";
import { useEffect as useEffect10, useState as useState9 } from "react";
var useCurrentLanguage = () => {
  const [currentLanguage, setCurrentLanguage] = useState9(i18n.language);
...
import React7, { memo as memo5, useCallback as useCallback10, useRef as useRef5 } from "react";
import styled from "styled-components";

// src/components/PixelBtn/PixelFlatBtn.tsx
import React6, { memo as memo4, useCallback as useCallback9, useRef as useRef4, useState as useState10 } from "react";
import { motion as motion2 } from "framer-motion";
var PixelFlatBtn = memo4((props) => {
  ...
  const clickHandle = useCallback9(
    (e) => {
...
`;
var ActivePixelCard = memo5((props) => {
  const { hidePixel } = props;
  return hidePixel ? /* @__PURE__ */ React7.createElement(PixelFlatBtn_default, {
    ...props
  }) : /* @__PURE__ */ React7.createElement(PixelStyled, {
    ...props
  });
});
var ActivePixelCardStyled = styled(ActivePixelCard)`
  cursor: pointer;
`;
var ActivePixelButton = memo5((props) => {
...
`;
var ActivePixelColorCard = memo5((props) => {
  const {
    className,
    borderColor,
    backgroundColor,
...
`;
var ActivePixelButtonColor = memo5((props) => {
  return /* @__PURE__ */ React7.createElement(ActivePixelButtonColorStyled, {
    ...props
  });
});
...
var PixelBorderCard = memo5((props) => {
  ...
  return hidePixel ? /* @__PURE__ */ React7.createElement(PixelFlatBtn_default, {
    ...props,
    onClick: clickHandle
  }) : /* @__PURE__ */ React7.createElement(PixelBorderStyled, {
    ...props,
...
`;
var PixelBorderCardButton = memo5((props) => {
...
var IsPixelWidget = memo6(
  ({
    ...
    return /* @__PURE__ */ React8.createElement(PixelBorderCardButton, {
...
var Language = memo7(({ type }) => {
  const isW768 = useIsW768();
  const lang = useCurrentLanguage();
  const { t } = useCustomTranslation([LngNs.common]);
  const changeLanguageHandle = useCallback11((item) => {
  ...
  return /* @__PURE__ */ React9.createElement("div", {
  ...
  }, type === "pixel" ? /* @__PURE__ */ React9.createElement("div", {
    className: "pixel_logo_wrap"
  }, /* @__PURE__ */ React9.createElement(IsPixelWidget_default, {
  ...
  }, /* @__PURE__ */ React9.createElement(PixelBorderCard, {
    className: "address_wrap_pop_lang",
    pixel_height: 4,
    backgroundColor: "#1D263B",
    borderColor: "#3A4254"
  }, languageList.map((v) => /* @__PURE__ */ React9.createElement(PopItem, {
    color: "#1D263B",
    ...
    name: "language"
  }), isW768 ? "Language" : t("language")), /* @__PURE__ */ React9.createElement("div", {
    className: "lang_list"
  }, languageList.map((v) => /* @__PURE__ */ React9.createElement(PopItem, {
    color: "transparent",
    onColor: "#3A4254",
...
var PopItem = memo7(
  ({
    ...
    return /* @__PURE__ */ React9.createElement(PixelCube2, {
      ...
      width: "100%",
      height: "36px"
    }, /* @__PURE__ */ React9.createElement(SvgComponent_default, {
      src: iconName
    }), /* @__PURE__ */ React9.createElement("p", null, label));
  }
);
var Language_default = Language;
...
import React13, { memo as memo10 } from "react";
...
var IsTablePixelWidget = memo10(
  ({
    ...
    const isW768 = useIsW768();
    return isW768 ? /* @__PURE__ */ React13.createElement("div", {
      className
    }, header_children, body_children) : /* @__PURE__ */ React13.createElement(PixelTable, {
      width,
      height,
      className,
      backgroundColor,
...
import React14, { memo as memo11 } from "react";
...
import React15, { memo as memo12 } from "react";
...
import React22, { memo as memo19, useMemo as useMemo6 } from "react";

// src/components/SideBar/component/CommunityLink.tsx
import React17, { memo as memo14 } from "react";
...
import React19, { memo as memo16 } from "react";

// src/components/SideBar/component/LinkItemA.tsx
import classnames5 from "classnames";
import React18, { memo as memo15, useCallback as useCallback13 } from "react";
...
import React20, { memo as memo17 } from "react";
...
var SideBarTitleLink = memo17(
  ({ logo_url_name, link, className, logo_title }) => {
    const { t } = useCustomTranslation([LngNs.sideBar]);
    return /* @__PURE__ */ React20.createElement("a", {
      href: link,
      className
...
var Navigation = memo18(
  ({ pathname, Link }) => {
    ...
    ).map((v, index) => /* @__PURE__ */ React21.createElement(LinkComp, {
      Link,
      item: v,
      key: v.label,
...
var ZypherLogo = memo19(
  ({ Link, isMobile: isMobile2 }) => {
    return /* @__PURE__ */ React22.createElement(LinkComp2, {
      Link,
      href: "/",
    ...
    }) : window.isGames ? /* @__PURE__ */ React22.createElement("img", {
      fetchPriority: "high",
      decoding: "async",
      loading: "lazy",
...
var SideBar = (props) => {
  ...
  }, /* @__PURE__ */ React22.createElement(icons_default, {
    name: "close"
  })), /* @__PURE__ */ React22.createElement("div", {
    className: "sidebar"
...
import React23, { memo as memo20 } from "react";
var DivWrap = memo20(
  ({
    className,
    showDiv,
...
import React25, { memo as memo22, useCallback as useCallback16, useEffect as useEffect13, useMemo as useMemo7 } from "react";
...
import React24, { memo as memo21, useCallback as useCallback15 } from "react";
...
import React92, { useEffect as useEffect33, useMemo as useMemo17 } from "react";
...
import React91, { memo as memo33 } from "react";

// src/components/Header/rainbow_account/rainbow_account.tsx
import React37, { memo as memo31, useCallback as useCallback25 } from "react";
...
import React28, { memo as memo25, useCallback as useCallback18, useEffect as useEffect15, useState as useState15 } from "react";
...
import React27, { memo as memo24, useCallback as useCallback17, useEffect as useEffect14 } from "react";

// src/components/ConnectWallet/components/PointsDialog/GetPointsSuccess.tsx
import React26, { memo as memo23 } from "react";
...
var Balance = memo25((props) => {
  ...
  }) : null, !isMiddleWidth && /* @__PURE__ */ React28.createElement(balanceItem_default, {
...
import React29, { memo as memo26, useCallback as useCallback19 } from "react";
...
import React36, { memo as memo30, useCallback as useCallback24 } from "react";

// src/components/PlayerAvatar/index.tsx
import cx from "classnames";
import React32, { memo as memo27, useMemo as useMemo8 } from "react";
...
import React35, { memo as memo29, useCallback as useCallback23, useEffect as useEffect17, useState as useState17 } from "react";
...
import React33, { createContext as createContext2, useContext as useContext2, useMemo as useMemo9 } from "react";
...
import React34, { memo as memo28, useCallback as useCallback22, useMemo as useMemo11 } from "react";
  ...
  ({ account, chainId, copy, cancel, type }) => {
    ...
    const list = useMemo11(() => {
      return [
        {
          balanceStr: pointsBalanceStr,
          logo: /* @__PURE__ */ React34.createElement(PointsIcon, {
            isMobile: isMobile2
          }),
          symbol: "Gold Points"
        },
        {
          balanceStr: nativeBalanceStr,
          logo: /* @__PURE__ */ React34.createElement(CurrencyLogo_default, {
    ...
    }, /* @__PURE__ */ React34.createElement(ChainSelectorWidget_default, {
      direction_type: "userPop",
      type: "pixel",
      className: classnames9("m_user_chain")
    }), /* @__PURE__ */ React34.createElement(PixelBorderCard, {
      pixel_height: 3,
      backgroundColor: "#343C4F",
      borderColor: "#484F60",
    ...
    }, t("Your Wallet")), /* @__PURE__ */ React34.createElement("div", {
      className: "m_user_userInfoInner"
    }, /* @__PURE__ */ React34.createElement(PlayerAvatar_default, {
    ...
    }, list.map((v) => /* @__PURE__ */ React34.createElement("div", {
      key: v.symbol,
      className: "m_user_item"
    }, /* @__PURE__ */ React34.createElement("div", {
      className: "m_user_fl"
    }, v.logo, /* @__PURE__ */ React34.createElement("p", null, v.symbol)), /* @__PURE__ */ React34.createElement("p", null, v.balanceStr))))), /* @__PURE__ */ React34.createElement(PixelBorderCard, {
      pixel_height: 3,
      backgroundColor: "#343C4F",
      borderColor: "#484F60",
      className: "m_user_border"
    ...
    }, /* @__PURE__ */ React34.createElement(FunItem, {
...
var FunItem = memo28(
  ({
    ...
    return /* @__PURE__ */ React34.createElement("div", {
      ...
      name: iconName
    }), /* @__PURE__ */ React34.createElement("p", null, label));
  }
);
...
var AccountInfoDialog = memo29(({ copy }) => {
  ...
  return account && chainId ? /* @__PURE__ */ React35.createElement(React35.Fragment, null, /* @__PURE__ */ React35.createElement(Modal_default, {
...
var AddressBigWrapPop = memo29(({ copy }) => {
  ...
  return /* @__PURE__ */ React35.createElement("div", {
    ...
    backgroundColor: "#1D263B",
    borderColor: "#3A4254"
  }, /* @__PURE__ */ React35.createElement(AddressWrapPopItem, {
    iconName: "pixel_copy",
    label: "Copy address",
...
var AddressMiddleWrapPop = memo29(({ copy }) => {
  ...
  return /* @__PURE__ */ React35.createElement("div", {
    ...
    onClick: copyAddressHandle
  }, /* @__PURE__ */ React35.createElement("p", null, getShortenAddress(account)), /* @__PURE__ */ React35.createElement(icons_default, {
    name: "pixel_copy"
  ...
  }, /* @__PURE__ */ React35.createElement(BalanceItem2, {
  ...
  })), /* @__PURE__ */ React35.createElement(Language_default, {
    type: "list"
  }), /* @__PURE__ */ React35.createElement(AddressWrapPopItem, {
    iconName: "pixel_blockchain",
    label: "Blockchain Explorer",
...
var AddressWrapPopItem = memo29(
  ({
    ...
    return /* @__PURE__ */ React35.createElement(PixelCube2, {
...
var BalanceItem2 = memo29(
  ({
    ...
    return /* @__PURE__ */ React35.createElement("div", {
      ...
      className: "fl"
    }, logo, /* @__PURE__ */ React35.createElement("p", null, currency)), /* @__PURE__ */ React35.createElement("p", {
      className: "frText"
    }, balanceStr));
  }
);
...
var AccountInfo = memo30(
  ({ isW768, isMiddleWidth, copy, env, supportedChainList }) => {
    ...
    return /* @__PURE__ */ React36.createElement(React36.Fragment, null, /* @__PURE__ */ React36.createElement(IsPixelWidget_default, {
    ...
    }), !isMiddleWidth && !isW768 ? /* @__PURE__ */ React36.createElement(AddressBigWrapPop, {
      copy
    }) : null, isMiddleWidth && !isW768 ? /* @__PURE__ */ React36.createElement(AddressMiddleWrapPop, {
      copy
    }) : null), isW768 ? /* @__PURE__ */ React36.createElement(AccountInfoDialog_default, {
      copy
    }) : null);
  }
);
...
var Account2 = memo31(
  ({
    ...
    return /* @__PURE__ */ React37.createElement(React37.Fragment, null, /* @__PURE__ */ React37.createElement(Balance_default, {
      isMiddleWidth,
      CountUpNumber,
      env,
      showPointsModal
    }), /* @__PURE__ */ React37.createElement(AccountInfo_default, {
      isMiddleWidth,
      isW768,
      copy,
      env
    }), !isMiddleWidth && /* @__PURE__ */ React37.createElement(ChainSelectorWidget_default, null), /* @__PURE__ */ React37.createElement(PointsDialog_default, {
      env,
      dispatch,
      setSuccessToast,
      setErrorToast
    }), /* @__PURE__ */ React37.createElement(PointsRuleDialog_default, null));
  },
  isEqual
);
...
import React87, { memo as memo32 } from "react";
...
function RainbowKitAuthenticationProvider({
  ...
  return /* @__PURE__ */ React38.createElement(AuthenticationContext.Provider, {
    value: useMemo12(
...
import React53, { useCallback as useCallback30, useEffect as useEffect26, useState as useState21 } from "react";
...
var Box = React39.forwardRef(
  ({ as = "div", className, testId, ...props }, ref) => {
    ...
    return React39.createElement(as, {
...
import React51, { createContext as createContext10, useContext as useContext5 } from "react";
...
import React40, { createContext as createContext4, useContext as useContext4, useEffect as useEffect20, useState as useState19 } from "react";
...
function TransactionStoreProvider({ children }) {
  ...
  const chainId = useChainId();
  const [store] = useState19(() => storeSingleton != null ? storeSingleton : storeSingleton = createTransactionStore({ provider }));
  useEffect20(() => {
  ...
  return /* @__PURE__ */ React40.createElement(TransactionStoreContext.Provider, {
    value: store
  }, children);
}
...
import React43, { useEffect as useEffect21, useMemo as useMemo14, useState as useState20 } from "react";

// src/rainbowkit/src/components/Icons/Spinner.tsx
import React42, { useMemo as useMemo13 } from "react";
...
// src/rainbowkit/src/components/Icons/Spinner.tsx
var useRandomId = (prefix) => useMemo13(
...
var SpinnerIcon = ({
  ...
  })), /* @__PURE__ */ React42.createElement("foreignObject", {
    clipPath: `url(#${id})`,
    height: "21",
    width: "21",
    x: "0",
...
var EmojiAvatar = ({ address, ensImage, size }) => {
  ...
  const { color: backgroundColor, emoji } = useMemo14(
    () => emojiAvatarForAddress(address),
    [address]
  );
  return ensImage ? loaded ? /* @__PURE__ */ React43.createElement(Box, {
  ...
  }, /* @__PURE__ */ React43.createElement(SpinnerIcon, null)) : /* @__PURE__ */ React43.createElement(Box, {
    alignItems: "center",
    display: "flex",
    justifyContent: "center",
    overflow: "hidden",
...
import { useCallback as useCallback26, useEffect as useEffect22 } from "react";
...
import { useCallback as useCallback28, useEffect as useEffect24 } from "react";
...
import React45, { useReducer as useReducer2 } from "react";
function AsyncImage({
  alt,
  background,
  borderColor,
  ...
  return /* @__PURE__ */ React45.createElement(Box, {
    ...
    width: "full"
  }), borderColor ? /* @__PURE__ */ React45.createElement(Box, {
...
var AssetsIcon = () => /* @__PURE__ */ React46.createElement(AsyncImage, {
  background: "#d0d5de",
  borderRadius: "10",
  height: "48",
  src,
...
var LoginIcon = () => /* @__PURE__ */ React47.createElement(AsyncImage, {
  background: "#d0d5de",
  borderRadius: "10",
  height: "48",
  src: src2,
...
import React50, { useCallback as useCallback27, useRef as useRef9 } from "react";
...
function ActionButton({
  ...
  return /* @__PURE__ */ React49.createElement(PixelCube2, {
    pixel_height: 2,
  ...
  }, /* @__PURE__ */ React49.createElement(Text2, {
...
function SignIn({ onClose }) {
  const [{ status, ...state }, setState] = React50.useState({ status: "idle" });
  ...
  return /* @__PURE__ */ React50.createElement(Box, {
    ...
    textAlign: "center",
    weight: "heavy"
  }, "Verify your account")), /* @__PURE__ */ React50.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "column",
    gap: mobile ? "16" : "12"
    ...
    size: mobile ? "16" : "14",
    textAlign: "center"
  }, "To finish connecting, you must sign a message in your wallet to verify that you are the owner of this account."), status === "idle" && state.errorMessage ? /* @__PURE__ */ React50.createElement(Text2, {
    color: "error",
    size: mobile ? "16" : "14",
    textAlign: "center",
    weight: "bold"
  }, state.errorMessage) : null)), /* @__PURE__ */ React50.createElement(Box, {
  ...
  }), mobile ? /* @__PURE__ */ React50.createElement(ActionButton, {
    label: "Cancel",
    onClick: cancel,
    size: "large",
    type: "secondary"
...
function RainbowKitProvider({
  ...
  return /* @__PURE__ */ React51.createElement(RainbowKitChainProvider, {
    chains,
    initialChain
  }, /* @__PURE__ */ React51.createElement(CoolModeContext.Provider, {
    value: coolMode
  }, /* @__PURE__ */ React51.createElement(ModalSizeContext.Provider, {
    value: isSmallScreen ? ModalSizeOptions.COMPACT : modalSize
  }, /* @__PURE__ */ React51.createElement(ShowRecentTransactionsContext.Provider, {
    value: showRecentTransactions
  }, /* @__PURE__ */ React51.createElement(TransactionStoreProvider, null, /* @__PURE__ */ React51.createElement(AvatarContext.Provider, {
    value: avatarContext
  }, /* @__PURE__ */ React51.createElement(AppContext.Provider, {
    value: appContext
  }, /* @__PURE__ */ React51.createElement(ThemeIdContext.Provider, {
    value: id
  }, /* @__PURE__ */ React51.createElement(ModalProvider, null, theme ? /* @__PURE__ */ React51.createElement("div", {
    ...createThemeRootProps(id)
  }, /* @__PURE__ */ React51.createElement("style", {
...
import React52, { useCallback as useCallback29, useEffect as useEffect25, useRef as useRef10 } from "react";
...
function Dialog({ children, onClose, open, titleId }) {
  ...
  const mobile = isMobile();
  return /* @__PURE__ */ React53.createElement(React53.Fragment, null, open ? createPortal(
    /* @__PURE__ */ React53.createElement(RemoveScroll, {
      ...
      position: "fixed",
      role: "dialog"
    }, /* @__PURE__ */ React53.createElement(FocusTrap, {
      className: content,
...
import React54, { useContext as useContext6 } from "react";
...
function DialogContent3({
  ...
  return /* @__PURE__ */ React54.createElement(Box, {
    marginTop
  }, /* @__PURE__ */ React54.createElement(PixelBorderCard, {
    className: [
...
import React65, { useCallback as useCallback32, useContext as useContext9, useEffect as useEffect28, useState as useState23 } from "react";

// src/rainbowkit/src/components/Avatar/Avatar.tsx
import React55, { useContext as useContext7 } from "react";
function Avatar2({ address, imageUrl, loading, size }) {
  ...
  return /* @__PURE__ */ React55.createElement(Box, {
    ...
    userSelect: "none"
  }, /* @__PURE__ */ React55.createElement(AvatarComponent3, {
    address,
    ensImage: imageUrl,
    size
  })), typeof loading === "boolean" && /* @__PURE__ */ React55.createElement(Box, {
    color: "accentColor",
    display: "flex",
    height: "full",
    position: "absolute",
...
var CopiedIcon = () => /* @__PURE__ */ React56.createElement("svg", {
  fill: "none",
  height: "13",
  viewBox: "0 0 13 13",
  width: "13",
...
var CopyIcon = () => /* @__PURE__ */ React57.createElement("svg", {
  fill: "none",
  height: "16",
  viewBox: "0 0 17 16",
  width: "17",
...
var DisconnectIcon = () => /* @__PURE__ */ React58.createElement("svg", {
  fill: "none",
  height: "16",
  viewBox: "0 0 18 16",
  width: "18",
...
import React63, { useContext as useContext8 } from "react";
...
var ExternalLinkIcon = () => /* @__PURE__ */ React59.createElement("svg", {
  fill: "none",
  height: "19",
  viewBox: "0 0 20 19",
  width: "20",
...
var CancelIcon = () => /* @__PURE__ */ React60.createElement("svg", {
  fill: "none",
  height: "19",
  viewBox: "0 0 20 19",
  width: "20",
...
var SuccessIcon = () => /* @__PURE__ */ React61.createElement("svg", {
  fill: "none",
  height: "20",
  viewBox: "0 0 20 20",
  width: "20",
...
function TxItem({ tx }) {
  ...
  return /* @__PURE__ */ React62.createElement(React62.Fragment, null, /* @__PURE__ */ React62.createElement(Box, {
    ...explorerLink ? {
      as: "a",
    ...
    color
  }, /* @__PURE__ */ React62.createElement(Icon2, null)), /* @__PURE__ */ React62.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: mobile ? "3" : "1"
  }, /* @__PURE__ */ React62.createElement(Box, null, /* @__PURE__ */ React62.createElement(Text2, {
    color: "modalText",
    font: "body",
    size: mobile ? "16" : "14",
    weight: "bold"
  }, tx == null ? void 0 : tx.description)), /* @__PURE__ */ React62.createElement(Box, null, /* @__PURE__ */ React62.createElement(Text2, {
    color: tx.status === "pending" ? "modalTextSecondary" : color,
    font: "body",
    size: "14",
    weight: mobile ? "medium" : "regular"
  }, confirmationStatus)))), explorerLink && /* @__PURE__ */ React62.createElement(Box, {
    alignItems: "center",
    color: "modalTextDim",
    display: "flex"
  }, /* @__PURE__ */ React62.createElement(ExternalLinkIcon, null))));
}
...
function TxList({ address }) {
  ...
  return /* @__PURE__ */ React63.createElement(React63.Fragment, null, /* @__PURE__ */ React63.createElement(Box, {
  ...
  }, hasTransactions && /* @__PURE__ */ React63.createElement(Box, {
    ...
    display: "flex",
    justifyContent: "space-between"
  }, /* @__PURE__ */ React63.createElement(Text2, {
    color: "modalTextSecondary",
    size: mobile ? "16" : "14",
    weight: "semibold"
  }, "Recent Transactions"), /* @__PURE__ */ React63.createElement(Box, {
    style: {
      marginBottom: -6,
      marginLeft: -10,
      marginRight: -10,
    ...
    size: mobile ? "16" : "14",
    weight: "semibold"
  }, "Clear All"))))), /* @__PURE__ */ React63.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, hasTransactions ? visibleTxs.map((tx) => /* @__PURE__ */ React63.createElement(TxItem, {
    key: tx.hash,
    tx
  })) : /* @__PURE__ */ React63.createElement(React63.Fragment, null, /* @__PURE__ */ React63.createElement(Box, {
    padding: mobile ? "12" : "8"
  }, /* @__PURE__ */ React63.createElement(Text2, {
    color: "modalTextDim",
    size: mobile ? "16" : "14",
    weight: mobile ? "medium" : "bold"
  }, appName != null ? appName : "Your", " transactions will appear here...")), mobile && /* @__PURE__ */ React63.createElement(Box, {
    background: "generalBorderDim",
    height: "1",
    marginX: "12",
    marginY: "8"
  })))), explorerLink && /* @__PURE__ */ React63.createElement(Box, {
    paddingBottom: "18",
    paddingX: mobile ? "8" : "18"
  }, /* @__PURE__ */ React63.createElement(Box, {
    alignItems: "center",
  ...
  }, "View more on Explorer"), /* @__PURE__ */ React63.createElement(ExternalLinkIcon, null))));
}
...
function ProfileDetailsAction({
  ...
  return /* @__PURE__ */ React64.createElement(Box, {
    ...
    color: "modalText",
    height: "max"
  }, icon), /* @__PURE__ */ React64.createElement(Box, null, /* @__PURE__ */ React64.createElement(Text2, {
    color: "modalText",
    size: mobile ? "12" : "13",
    weight: "semibold"
  }, label))));
...
function ProfileDetails({
  ...
  return /* @__PURE__ */ React65.createElement(React65.Fragment, null, /* @__PURE__ */ React65.createElement(Box, {
    display: "flex",
    flexDirection: "column"
  ...
  }, /* @__PURE__ */ React65.createElement(DialogClose_default, {
    onClick: onClose
  })), /* @__PURE__ */ React65.createElement(Box, {
    marginTop: mobile ? "24" : "0"
  }, /* @__PURE__ */ React65.createElement(Avatar2, {
    address,
    imageUrl: ensAvatar,
    size: mobile ? 82 : 74
  })), /* @__PURE__ */ React65.createElement(Box, {
    ...
    textAlign: "center"
  }, /* @__PURE__ */ React65.createElement(Text2, {
    as: "h1",
    color: "modalText",
    id: titleId,
    size: mobile ? "20" : "18",
    weight: "heavy"
  }, accountName)), balanceData && /* @__PURE__ */ React65.createElement(Box, {
    textAlign: "center"
  }, /* @__PURE__ */ React65.createElement(Text2, {
    as: "h1",
    color: "modalTextSecondary",
    ...
    size: mobile ? "16" : "14",
    weight: "semibold"
  }, displayBalance, " ", balanceData.symbol)))), /* @__PURE__ */ React65.createElement(Box, {
    display: "flex",
    flexDirection: "row",
    gap: "8",
    margin: "2",
    marginTop: "16"
  }, /* @__PURE__ */ React65.createElement(ProfileDetailsAction, {
    action: copyAddressAction,
    icon: copiedAddress ? /* @__PURE__ */ React65.createElement(CopiedIcon, null) : /* @__PURE__ */ React65.createElement(CopyIcon, null),
    label: copiedAddress ? "Copied!" : "Copy Address"
  }), /* @__PURE__ */ React65.createElement(ProfileDetailsAction, {
    action: onDisconnect,
    icon: /* @__PURE__ */ React65.createElement(DisconnectIcon, null),
    label: "Disconnect",
    testId: "disconnect-button"
  }))), showRecentTransactions && /* @__PURE__ */ React65.createElement(React65.Fragment, null, /* @__PURE__ */ React65.createElement(Box, {
    background: "generalBorder",
    height: "1",
    marginTop: "-1"
  }), /* @__PURE__ */ React65.createElement(Box, null, /* @__PURE__ */ React65.createElement(TxList, {
    address
  })))));
}
...
function AccountModal({ onClose, open }) {
  ...
  return /* @__PURE__ */ React66.createElement(React66.Fragment, null, address && /* @__PURE__ */ React66.createElement(Dialog, {
    onClose,
    open,
    titleId
  }, /* @__PURE__ */ React66.createElement(DialogContent3, {
    bottomSheetOnMobile: true,
    padding: "0"
  }, /* @__PURE__ */ React66.createElement(ProfileDetails, {
    address,
    balanceData,
    ensAvatar,
    ensName,
...
import React69, { Fragment, useCallback as useCallback33, useContext as useContext10 } from "react";
...
var DisconnectSqIcon = ({ size }) => /* @__PURE__ */ React67.createElement("svg", {
  fill: "none",
  height: size,
  viewBox: "0 0 28 28",
  width: size,
...
// src/rainbowkit/src/components/MenuButton/MenuButton.tsx
var MenuButton = React68.forwardRef(
  ({
    children,
...
function ChainModal({ onClose, open, fn }) {
  ...
  return /* @__PURE__ */ React69.createElement(Dialog, {
    onClose,
    open,
    titleId
  }, /* @__PURE__ */ React69.createElement(DialogContent3, {
    padding: "0",
    bottomSheetOnMobile: true
    ...
    gap: isW768 ? "0" : "14",
    marginBottom: "14"
  }, /* @__PURE__ */ React69.createElement(ActivePixelCard, {
    pixel_height: 10,
    ...
    flexDirection: "row",
    justifyContent: "space-between"
  }, mobile && /* @__PURE__ */ React69.createElement(Box, {
    width: "30"
  }), /* @__PURE__ */ React69.createElement(Text2, {
    as: "h3",
    color: "modalText",
    weight: "bold",
    id: titleId,
  ...
  }, "Switch Networks"))), unsupportedChain && /* @__PURE__ */ React69.createElement(Box, {
    marginLeft: "20",
    marginRight: "20",
    ...
    size: "14",
    weight: "medium"
  }, "Wrong network detected, switch or disconnect to continue.")), /* @__PURE__ */ React69.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4",
    padding: "2",
    ...
    return /* @__PURE__ */ React69.createElement(Fragment, {
      key: chain.id
    }, /* @__PURE__ */ React69.createElement(MenuButton, {
      disabled: false,
      ...
      height: "full",
      marginRight: "8"
    }, /* @__PURE__ */ React69.createElement(AsyncImage, {
      ...
      width: chainIconSize
    })), /* @__PURE__ */ React69.createElement("div", null, (_a2 = chain.name) != null ? _a2 : name)), isCurrentChain && /* @__PURE__ */ React69.createElement(Box, {
      alignItems: "center",
      display: "flex",
      flexDirection: "row",
      marginRight: "6"
      ...
      size: "14",
      weight: "medium"
    }, "Connected"), /* @__PURE__ */ React69.createElement(Box, {
      ...
      marginLeft: "8",
      width: "12"
    })), switching && /* @__PURE__ */ React69.createElement(Box, {
      alignItems: "center",
      display: "flex",
      flexDirection: "row",
      marginRight: "6"
      ...
      size: "14",
      weight: "medium"
    }, "Confirm in Wallet"), /* @__PURE__ */ React69.createElement(Box, {
      background: "standby",
      borderRadius: "full",
      height: "12",
      marginLeft: "8",
      ...
      borderStyle: "solid",
      borderWidth: "3"
    }))))), mobile && idx < rainbowkitChains.length - 1 && /* @__PURE__ */ React69.createElement(Box, {
      background: "generalBorderDim",
      height: "1",
      marginX: "8"
    }));
    ...
    size: "14",
    weight: "medium"
  }, "Your wallet does not support switching networks from", " ", appName != null ? appName : "this app", ". Try switching networks from within your wallet instead.")), unsupportedChain && /* @__PURE__ */ React69.createElement(React69.Fragment, null, /* @__PURE__ */ React69.createElement(Box, {
    background: "generalBorderDim",
    height: "1",
    marginX: "8"
  }), /* @__PURE__ */ React69.createElement(MenuButton, {
    ...
    justifyContent: "center",
    marginRight: "8"
  }, /* @__PURE__ */ React69.createElement(DisconnectSqIcon, {
    size: Number(chainIconSize)
  })), /* @__PURE__ */ React69.createElement("div", null, "Disconnect")))))))), /* @__PURE__ */ React69.createElement(DialogClose_default, {
    onClick: onClose
  })));
}
...
import React82, { Fragment as Fragment2, useContext as useContext14, useEffect as useEffect31, useState as useState25 } from "react";
...
import React72, { useContext as useContext11 } from "react";
...
var DisclaimerText = ({ children }) => {
  return /* @__PURE__ */ React71.createElement(Text2, {
    color: "modalTextSecondary",
    size: "12",
    weight: "medium"
  }, children);
...
function ConnectModalIntro({
  ...
  return /* @__PURE__ */ React72.createElement(React72.Fragment, null, /* @__PURE__ */ React72.createElement(Box, {
    ...
    marginBottom: "10"
  }, !compactModeEnabled && /* @__PURE__ */ React72.createElement(Text2, {
    color: "modalText",
    size: "18",
    weight: "heavy"
  }, "What is a Wallet?")), /* @__PURE__ */ React72.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "32",
    justifyContent: "center",
    ...
    minWidth: "48",
    width: "48"
  }, /* @__PURE__ */ React72.createElement(AssetsIcon, null)), /* @__PURE__ */ React72.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
    ...
    size: "14",
    weight: "bold"
  }, "A Home for your Digital Assets"), /* @__PURE__ */ React72.createElement(Text2, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, "Wallets are used to send, receive, store, and display digital assets like Ethereum and NFTs."))), /* @__PURE__ */ React72.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "row",
    gap: "16"
    ...
    minWidth: "48",
    width: "48"
  }, /* @__PURE__ */ React72.createElement(LoginIcon, null)), /* @__PURE__ */ React72.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, /* @__PURE__ */ React72.createElement(Text2, {
    ...
    size: "14",
    weight: "bold"
  }, "A New Way to Log In"), /* @__PURE__ */ React72.createElement(Text2, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, "Instead of creating new accounts and passwords on every website, just connect your wallet.")))), /* @__PURE__ */ React72.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "column",
    gap: "12",
    justifyContent: "center",
    margin: "10"
  }, /* @__PURE__ */ React72.createElement(ActionButton, {
    label: "Get a Wallet",
    onClick: getWallet
  }), /* @__PURE__ */ React72.createElement(Box, {
    as: "a",
    ...
    size: "14",
    weight: "bold"
  }, "Learn More"))), Disclaimer && !compactModeEnabled && /* @__PURE__ */ React72.createElement(Box, {
    marginBottom: "8",
    marginTop: "12",
    textAlign: "center"
  }, /* @__PURE__ */ React72.createElement(Disclaimer, {
    Link: DisclaimerLink,
    Text: DisclaimerText
  }))));
}
...
var BackIcon = () => /* @__PURE__ */ React73.createElement("svg", {
  fill: "none",
  height: "17",
  viewBox: "0 0 11 17",
  width: "11",
...
var InfoIcon = () => /* @__PURE__ */ React74.createElement("svg", {
  fill: "none",
  height: "12",
  viewBox: "0 0 8 12",
  width: "8",
...
var InfoButton = ({
  ...
  return /* @__PURE__ */ React75.createElement(Box, {
    ...
    type: "button",
    width: mobile ? "30" : "28"
  }, /* @__PURE__ */ React75.createElement(InfoIcon, null));
};
...
var ModalSelection = ({
  ...
  return /* @__PURE__ */ React76.createElement(Box, {
    ...
    ref: coolModeRef
  }, /* @__PURE__ */ React76.createElement(ActivePixelCard, {
    pixel_height: 4,
    ...currentlySelected ? {
      backgroundColor: "#1649FF"
    } : {
    ...
    gap: "12",
    width: "max"
  }, /* @__PURE__ */ React76.createElement(AsyncImage, {
    background: iconBackground,
    ...
    src: iconUrl,
    width: "28"
  }), /* @__PURE__ */ React76.createElement(Box, null, /* @__PURE__ */ React76.createElement(Box, {
    style: { marginTop: recent ? -2 : void 0 }
  }, name), recent && /* @__PURE__ */ React76.createElement(Text2, {
...
import React81, { useContext as useContext13, useEffect as useEffect30 } from "react";
...
var CreateIcon = () => /* @__PURE__ */ React77.createElement(AsyncImage, {
  background: "#e3a5e8",
...
var RefreshIcon = () => /* @__PURE__ */ React78.createElement(AsyncImage, {
  background: "#515a70",
  borderColor: "generalBorder",
  borderRadius: "10",
  height: "48",
...
var ScanIcon = () => /* @__PURE__ */ React79.createElement(AsyncImage, {
  background: "#515a70",
  borderColor: "generalBorder",
  borderRadius: "10",
  height: "48",
...
function QRCode({
  ...
  const dots = useMemo15(() => {
    ...
    qrList.forEach(({ x, y }) => {
      ...
      for (let i = 0; i < 3; i++) {
        dots2.push(
          /* @__PURE__ */ React80.createElement("rect", {
        ...
        if (matrix[i][j]) {
          if (!(i < 7 && j < 7 || i > matrix.length - 8 && j < 7 || i < 7 && j > matrix.length - 8)) {
            if (!(i > matrixMiddleStart && i < matrixMiddleEnd && j > matrixMiddleStart && j < matrixMiddleEnd)) {
              dots2.push(
                /* @__PURE__ */ React80.createElement("circle", {
  ...
  return /* @__PURE__ */ React80.createElement(Box, {
    ...
    style: { all: "revert" },
    width: size
  }, /* @__PURE__ */ React80.createElement("defs", null, /* @__PURE__ */ React80.createElement("clipPath", {
    id: "clip-wrapper"
  }, /* @__PURE__ */ React80.createElement("rect", {
    height: logoWrapperSize,
    width: logoWrapperSize
  })), /* @__PURE__ */ React80.createElement("clipPath", {
    id: "clip-logo"
  }, /* @__PURE__ */ React80.createElement("rect", {
    height: logoSize,
    width: logoSize
...
function GetDetail({
  ...
  return /* @__PURE__ */ React81.createElement(Box, {
    ...
    return /* @__PURE__ */ React81.createElement(Box, {
      ...
      size: "14",
      weight: "bold"
    }, name), /* @__PURE__ */ React81.createElement(Text2, {
      color: "modalTextSecondary",
      size: "14",
      weight: "medium"
    }, hasMobileAndExtension ? "Mobile Wallet and Extension" : hasMobileCompanionApp ? "Mobile Wallet" : hasExtension ? "Browser Extension" : null))), /* @__PURE__ */ React81.createElement(Box, {
      display: "flex",
      flexDirection: "column",
      gap: "4"
    ...
    size: "14",
    weight: "bold"
  }, "Not what you\u2019re looking for?"), /* @__PURE__ */ React81.createElement(Text2, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
...
function ConnectDetail({
  ...
  return /* @__PURE__ */ React81.createElement(Box, {
    ...
    height: "full",
    width: "full"
  }, hasQrCode ? /* @__PURE__ */ React81.createElement(Box, {
    alignItems: "center",
    display: "flex",
    height: "full",
    justifyContent: "center"
  }, /* @__PURE__ */ React81.createElement(QRCode, {
    ...
    size: "18",
    weight: "bold"
  }, ready ? `Opening ${name}...` : hasExtension ? `${name} is not installed` : `${name} is not available`), !ready && hasExtension ? /* @__PURE__ */ React81.createElement(Box, {
    paddingTop: "20"
  }, /* @__PURE__ */ React81.createElement(ActionButton, {
    href: wallet.extensionDownloadUrl,
    label: "INSTALL",
    type: "secondary"
  })) : null, ready && !hasQrCode && /* @__PURE__ */ React81.createElement(React81.Fragment, null, /* @__PURE__ */ React81.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "column",
    justifyContent: "center"
    ...
    textAlign: "center",
    weight: "medium"
  }, "Confirm connection in the extension")), /* @__PURE__ */ React81.createElement(Box, {
    alignItems: "center",
    color: "modalText",
    display: "flex",
    flexDirection: "row",
    height: "32",
    marginTop: "8"
  }, connectionError ? /* @__PURE__ */ React81.createElement(ActionButton, {
    label: "RETRY",
    ...
    color: "modalTextSecondary"
  }, /* @__PURE__ */ React81.createElement(SpinnerIcon, null))))))), /* @__PURE__ */ React81.createElement(Box, {
    alignItems: "center",
    borderRadius: "10",
    display: "flex",
    flexDirection: "row",
    ...
    justifyContent: "space-between",
    marginTop: "12"
  }, ready && secondaryAction && /* @__PURE__ */ React81.createElement(React81.Fragment, null, /* @__PURE__ */ React81.createElement(Text2, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, secondaryAction.description), /* @__PURE__ */ React81.createElement(ActionButton, {
...
var DownloadOptionsBox = ({
  ...
  return /* @__PURE__ */ React81.createElement(Box, {
  ...
  }), isBrowserCard && /* @__PURE__ */ React81.createElement(Box, {
    ...
    src: iconUrl,
    width: "200"
  })))), !isBrowserCard && gradientRgbas && /* @__PURE__ */ React81.createElement(Box, {
    ...
    justifyContent: "center",
    style: { zIndex: 1 }
  }, /* @__PURE__ */ React81.createElement(Box, null, /* @__PURE__ */ React81.createElement(AsyncImage, {
    height: "60",
    src: iconUrl,
    width: "60",
    ...iconBackground ? {
    ...
    size: "14",
    weight: "bold"
  }, title), /* @__PURE__ */ React81.createElement(Text2, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, description), /* @__PURE__ */ React81.createElement(Box, {
    marginTop: "14",
    width: "max"
  }, /* @__PURE__ */ React81.createElement(ActionButton, {
    href: url,
...
function DownloadOptionsDetail({
  ...
  return /* @__PURE__ */ React81.createElement(Box, {
    ...
    justifyContent: "center",
    width: "full"
  }, extensionDownloadUrl && /* @__PURE__ */ React81.createElement(DownloadOptionsBox, {
    ...
    variant: "browser"
  }), mobileDownloadUrl && /* @__PURE__ */ React81.createElement(DownloadOptionsBox, {
...
function DownloadDetail({
  ...
  return /* @__PURE__ */ React81.createElement(Box, {
    ...
    size: "14",
    weight: "semibold"
  }, "Scan with your phone to download on iOS or Android")), /* @__PURE__ */ React81.createElement(Box, {
    height: "full"
  }, (downloadUrls == null ? void 0 : downloadUrls.qrCode) ? /* @__PURE__ */ React81.createElement(QRCode, {
    logoSize: 0,
    size: 268,
    uri: downloadUrls.qrCode
  }) : null), /* @__PURE__ */ React81.createElement(Box, {
    alignItems: "center",
    borderRadius: "10",
    display: "flex",
    flexDirection: "row",
...
var stepIcons = {
  create: () => /* @__PURE__ */ React81.createElement(CreateIcon, null),
  install: (wallet) => /* @__PURE__ */ React81.createElement(AsyncImage, {
  ...
  refresh: () => /* @__PURE__ */ React81.createElement(RefreshIcon, null),
  scan: () => /* @__PURE__ */ React81.createElement(ScanIcon, null)
};
function InstructionMobileDetail({
  ...
  return /* @__PURE__ */ React81.createElement(Box, {
    ...
    return /* @__PURE__ */ React81.createElement(Box, {
      ...
      position: "relative",
      width: "48"
    }, (_a2 = stepIcons[d.step]) == null ? void 0 : _a2.call(stepIcons, wallet)), /* @__PURE__ */ React81.createElement(Box, {
      display: "flex",
      flexDirection: "column",
      gap: "4"
    }, /* @__PURE__ */ React81.createElement(Text2, {
      ...
      size: "14",
      weight: "bold"
    }, d.title), /* @__PURE__ */ React81.createElement(Text2, {
      color: "modalTextSecondary",
      size: "14",
      weight: "medium"
    }, d.description)));
...
function DesktopOptions({ onClose }) {
  ...
  switch (walletStep) {
    case "NONE" /* None */:
      walletContent = /* @__PURE__ */ React82.createElement(ConnectModalIntro, {
    ...
    case "LEARN_COMPACT" /* LearnCompact */:
      ...
      break;
    case "GET" /* Get */:
      walletContent = /* @__PURE__ */ React82.createElement(GetDetail, {
        getWalletDownload
      });
    ...
    case "CONNECT" /* Connect */:
      walletContent = selectedWallet && /* @__PURE__ */ React82.createElement(ConnectDetail, {
        changeWalletStep,
        compactModeEnabled,
        connectionError,
        onClose,
    ...
    case "DOWNLOAD_OPTIONS" /* DownloadOptions */:
      walletContent = selectedWallet && /* @__PURE__ */ React82.createElement(DownloadOptionsDetail, {
        changeWalletStep,
        wallet: selectedWallet
      });
    ...
    case "DOWNLOAD" /* Download */:
      walletContent = selectedWallet && /* @__PURE__ */ React82.createElement(DownloadDetail, {
        changeWalletStep,
        wallet: selectedWallet
      });
    ...
    case "INSTRUCTIONS_MOBILE" /* InstructionsMobile */:
      walletContent = selectedWallet && /* @__PURE__ */ React82.createElement(InstructionMobileDetail, {
    ...
    case "INSTRUCTIONS_EXTENSION" /* InstructionsExtension */:
      walletContent = selectedWallet && /* @__PURE__ */ React82.createElement(InstructionExtensionDetail, {
        wallet: selectedWallet
      });
      headerLabel = selectedWallet && `Get started with ${compactModeEnabled ? selectedWallet.shortName || selectedWallet.name : selectedWallet.name}`;
  ...
  return /* @__PURE__ */ React82.createElement(Box, {
  ...
  }, (compactModeEnabled ? walletStep === "NONE" /* None */ : true) && /* @__PURE__ */ React82.createElement(Box, {
    ...
    display: "flex",
    justifyContent: "space-between"
  }, compactModeEnabled && Disclaimer && /* @__PURE__ */ React82.createElement(Box, {
    marginLeft: "16",
    width: "28"
  }, /* @__PURE__ */ React82.createElement(InfoButton, {
    ...
    size: "18",
    weight: "heavy"
  }, "Connect a Wallet")), compactModeEnabled && /* @__PURE__ */ React82.createElement(Box, {
    marginRight: "16"
  }, /* @__PURE__ */ React82.createElement(DialogClose_default, {
    onClick: onClose
  }))), /* @__PURE__ */ React82.createElement(Box, {
    className: ScrollClassName,
    paddingBottom: "18"
  }, Object.entries(groupedWallets).map(
    ([groupName, wallets2], index) => wallets2.length > 0 && /* @__PURE__ */ React82.createElement(Fragment2, {
      key: index
    }, groupName ? /* @__PURE__ */ React82.createElement(Box, {
      marginBottom: "8",
      marginTop: "16",
      marginX: "6"
    }, /* @__PURE__ */ React82.createElement(Text2, {
      ...
      size: "14",
      weight: "bold"
    }, groupName)) : null, /* @__PURE__ */ React82.createElement(Box, {
      display: "flex",
      flexDirection: "column",
      gap: "4"
    }, wallets2.map((wallet) => {
      return /* @__PURE__ */ React82.createElement(ModalSelection, {
  ...
  )), compactModeEnabled && /* @__PURE__ */ React82.createElement(React82.Fragment, null, /* @__PURE__ */ React82.createElement(Box, {
    background: "generalBorder",
    height: "1",
    marginTop: "-1"
  }), Disclaimer ? /* @__PURE__ */ React82.createElement(Box, {
    paddingX: "24",
    paddingY: "16",
    textAlign: "center"
  }, /* @__PURE__ */ React82.createElement(Disclaimer, {
    Link: DisclaimerLink,
    Text: DisclaimerText
  })) : /* @__PURE__ */ React82.createElement(Box, {
    alignItems: "center",
    ...
    size: "14",
    weight: "medium"
  }, "New to Ethereum wallets?")), /* @__PURE__ */ React82.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "row",
    gap: "4",
    ...
    size: "14",
    weight: "bold"
  }, "Learn More")))))), (compactModeEnabled ? walletStep !== "NONE" /* None */ : true) && /* @__PURE__ */ React82.createElement(React82.Fragment, null, !compactModeEnabled && /* @__PURE__ */ React82.createElement(Box, {
    background: "generalBorder",
    minWidth: "1",
    width: "1"
  }), /* @__PURE__ */ React82.createElement(Box, {
    ...
    width: "28"
  }, headerBackButtonLink && /* @__PURE__ */ React82.createElement(Box, {
    as: "button",
    className: touchableStyles({
      active: "shrinkSm",
      hover: "growLg"
    ...
    transition: "default",
    type: "button"
  }, /* @__PURE__ */ React82.createElement(BackIcon, null))), /* @__PURE__ */ React82.createElement(Box, {
    display: "flex",
    justifyContent: "center",
    style: { flexGrow: 1 }
  }, headerLabel && /* @__PURE__ */ React82.createElement(Text2, {
    color: "modalText",
    size: "18",
    textAlign: "center",
    weight: "heavy"
  }, headerLabel)), /* @__PURE__ */ React82.createElement(DialogClose_default, {
    onClick: onClose
  })), /* @__PURE__ */ React82.createElement(Box, {
    display: "flex",
    flexDirection: "column",
...
import React83, { useCallback as useCallback34, useContext as useContext15, useState as useState26 } from "react";
...
function WalletButton({
  ...
  return /* @__PURE__ */ React83.createElement(Box, {
    ...
    paddingBottom: "8",
    paddingTop: "10"
  }, /* @__PURE__ */ React83.createElement(AsyncImage, {
    background: iconBackground,
    borderRadius: "13",
    ...
    as: "span",
    position: "relative"
  }, shortName != null ? shortName : name, !wallet.ready && " (unsupported)")), wallet.recent && /* @__PURE__ */ React83.createElement(Text2, {
    color: "accentColor",
    size: "12",
    weight: "medium"
  }, "Recent"))));
...
function MobileOptions({ onClose }) {
  ...
  switch (walletStep) {
    case "CONNECT" /* Connect */: {
      ...
      walletContent = /* @__PURE__ */ React83.createElement(Box, null, /* @__PURE__ */ React83.createElement(Box, {
        background: "profileForeground",
        className: scroll,
        display: "flex",
        paddingBottom: "20",
        ...
        return /* @__PURE__ */ React83.createElement(Box, {
          ...
          width: "60"
        }, /* @__PURE__ */ React83.createElement(WalletButton, {
          onClose,
          wallet
        })));
      }))), /* @__PURE__ */ React83.createElement(Box, {
        ...
        size: "16",
        weight: "bold"
      }, "What is a Wallet?"), /* @__PURE__ */ React83.createElement(Text2, {
        color: "modalTextSecondary",
        size: "16"
      }, "A wallet is used to send, receive, store, and display digital assets. It\u2019s also a new way to log in, without needing to create new accounts and passwords on\xA0every\xA0website."))), /* @__PURE__ */ React83.createElement(Box, {
        paddingTop: "32",
        paddingX: "20"
      }, /* @__PURE__ */ React83.createElement(Box, {
        display: "flex",
        gap: "14",
        justifyContent: "center"
      }, /* @__PURE__ */ React83.createElement(ActionButton, {
        label: "Get a Wallet",
    ...
    case "GET" /* Get */: {
      ...
      walletContent = /* @__PURE__ */ React83.createElement(Box, null, /* @__PURE__ */ React83.createElement(Box, {
        ...
        return /* @__PURE__ */ React83.createElement(Box, {
          ...
          size: "18",
          weight: "bold"
        }, name)), /* @__PURE__ */ React83.createElement(ActionButton, {
          ...
          size: "small",
          type: "secondary"
        })), index < mobileWallets.length - 1 && /* @__PURE__ */ React83.createElement(Box, {
          background: "generalBorderDim",
          height: "1",
          marginY: "10",
          width: "full"
        ...
        size: "16",
        weight: "bold"
      }, "Not what you\u2019re looking for?"), /* @__PURE__ */ React83.createElement(Text2, {
        color: "modalTextSecondary",
        size: "16"
  ...
  return /* @__PURE__ */ React83.createElement(Box, {
    ...
    size: "20",
    weight: "bold"
  }, headerLabel)), /* @__PURE__ */ React83.createElement(Box, {
    alignItems: "center",
    display: "flex",
    height: "32",
    paddingRight: "14",
...
function ConnectOptions({ onClose }) {
  return isMobile() ? /* @__PURE__ */ React84.createElement(MobileOptions, {
    onClose
  }) : /* @__PURE__ */ React84.createElement(DesktopOptions, {
    onClose
  });
}
...
function ConnectModal({ onClose, open }) {
  ...
  if (connectionStatus === "disconnected") {
    return /* @__PURE__ */ React85.createElement(Dialog, {
      onClose,
      open,
      titleId
    }, /* @__PURE__ */ React85.createElement(DialogContent3, {
      bottomSheetOnMobile: true,
      padding: "0",
      wide: true
    }, /* @__PURE__ */ React85.createElement(ConnectOptions, {
      onClose
    })));
  }
  if (connectionStatus === "unauthenticated") {
    return /* @__PURE__ */ React85.createElement(Dialog, {
      ...
      bottomSheetOnMobile: true,
      padding: "0"
    }, /* @__PURE__ */ React85.createElement(SignIn, {
      onClose
    })));
  }
  return null;
...
function ModalProvider({ children }) {
  ...
  return /* @__PURE__ */ React86.createElement(ModalContext.Provider, {
    value: useMemo16(
      () => ({
        accountModalOpen,
        chainModalOpen,
  ...
  }, children, /* @__PURE__ */ React86.createElement(ConnectModal, {
    onClose: closeConnectModal,
    open: connectModalOpen
  }), /* @__PURE__ */ React86.createElement(AccountModal, {
    onClose: closeAccountModal,
    open: accountModalOpen
  }), /* @__PURE__ */ React86.createElement(ChainModal, {
...
var WrongNetwork = memo32(() => {
  ...
  return /* @__PURE__ */ React87.createElement(IsPixelWidget_default, {
    onClick: () => {
      if (openChainModal) {
        openChainModal();
        setAccountInfoDialogOpen(false);
  ...
  }, /* @__PURE__ */ React87.createElement("p", null, t("Wrong network")));
}, isEqual);
...
var DropdownIcon = () => /* @__PURE__ */ React88.createElement("svg", {
  fill: "none",
  height: "7",
  width: "14",
  xmlns: "http://www.w3.org/2000/svg"
...
import React89, { useContext as useContext17 } from "react";
...
function ConnectButton({
  ...
  const connectionStatus = useConnectionStatus();
  return /* @__PURE__ */ React90.createElement(ConnectButtonRenderer, null, ({ account, chain, mounted, openAccountModal, openChainModal, openConnectModal }) => {
    var _a, _b, _c;
    ...
    return /* @__PURE__ */ React90.createElement(Box, {
    ...
    }, ready && account && connectionStatus === "connected" ? /* @__PURE__ */ React90.createElement(React90.Fragment, null, chain && (chains.length > 1 || unsupportedChain) && /* @__PURE__ */ React90.createElement(Box, {
      alignItems: "center",
      ...
      transition: "default",
      type: "button"
    }, unsupportedChain ? /* @__PURE__ */ React90.createElement(Box, {
      alignItems: "center",
      display: "flex",
      height: "24",
      paddingX: "4"
    }, "Wrong network") : /* @__PURE__ */ React90.createElement(Box, {
      alignItems: "center",
      display: "flex",
      gap: "6"
    }, chain.hasIcon ? /* @__PURE__ */ React90.createElement(Box, {
    ...
    }, (_c = chain.name) != null ? _c : chain.id)), /* @__PURE__ */ React90.createElement(DropdownIcon, null)), !unsupportedChain && /* @__PURE__ */ React90.createElement(Box, {
      alignItems: "center",
      as: "button",
      ...
      transition: "default",
      type: "button"
    }, account.displayBalance && /* @__PURE__ */ React90.createElement(Box, {
    ...
    }, /* @__PURE__ */ React90.createElement(Avatar2, {
    ...
    }, account.displayName), /* @__PURE__ */ React90.createElement(DropdownIcon, null)))))) : /* @__PURE__ */ React90.createElement(Box, {
      as: "button",
...
var RainbowConnectWallet = memo33((props) => {
  ...
  return /* @__PURE__ */ React91.createElement("div", {
    className: `connect_pixel_connectWallet
        ${className != null ? className : ""}`
  }, /* @__PURE__ */ React91.createElement(ConnectButton.Custom, null, ({ chain, openConnectModal, mounted }) => {
    return /* @__PURE__ */ React91.createElement(React91.Fragment, null, !mounted || !chain ? /* @__PURE__ */ React91.createElement(IsPixelWidget_default, {
      onClick: openConnectModal,
      className: "connect_connect"
    }, /* @__PURE__ */ React91.createElement("p", null, t("Connect Wallet"))) : chain && (chain.unsupported || !supportedChainIds(env, supportedChainList).includes(
      `${chain.id}`
    )) ? /* @__PURE__ */ React91.createElement(WrongNetwork_default, null) : /* @__PURE__ */ React91.createElement(rainbow_account_default, {
      copy,
      env,
      dispatch,
      setSuccessToast,
  ...
  }), isBigWidth ? /* @__PURE__ */ React91.createElement(Language_default, {
...
var Header = (props) => {
  ...
  const { isW830, isW1190, isW1340, isW1540, isW1670, isWBig } = useMemo17(() => {
    return {
      isW830: width <= 830,
      isW1190: width <= 1190,
      isW1340: width <= 1340,
  ...
  return /* @__PURE__ */ React92.createElement("header", {
  ...
  }, isBingo ? null : /* @__PURE__ */ React92.createElement("div", {
    className: "header_left"
  }, /* @__PURE__ */ React92.createElement(ZypherLogo, {
    Link,
    isMobile: isW830
  })), !isW830 && !isBingo && /* @__PURE__ */ React92.createElement(Navigation_default, {
    pathname,
    Link
  }), /* @__PURE__ */ React92.createElement("div", {
    className: "header_right"
  }, /* @__PURE__ */ React92.createElement(rainbow_connectWallet_default, {
    type: "pixel",
    isBigWidth: isWBig,
    ...
    CountUpNumber,
    supportedChainList
  }), isW830 && !hideMenu ? /* @__PURE__ */ React92.createElement(IsPixelWidget_default, {
    className: "header_btn_pixel"
  }, /* @__PURE__ */ React92.createElement("div", {
    className: "header_btn",
    onClick: () => setSideCollapse(!collapsed)
  }, /* @__PURE__ */ React92.createElement(icons_default, {
    className: "header_icon",
    name: "menu"
  }))) : null), /* @__PURE__ */ React92.createElement(LinkToBetaDialog_default, null));
};
var header_default = Header;

// src/provider/RainbowKitWithThemeProvider.tsx
import React93, { useMemo as useMemo18 } from "react";
...
var RainbowKitWithThemeProvider = ({
  ...
  return /* @__PURE__ */ React93.createElement(WagmiConfig, {
    config: wagmiConfig
  }, /* @__PURE__ */ React93.createElement(RainbowKitProvider, {
    chains,
    appInfo,
    theme: computedTheme
  }, children));
...
var TonConnectUIProvider = memo34(({ children }) => {
  return /* @__PURE__ */ React94.createElement(TonConnectUIProviderWidget, {
    uiPreferences: {
      theme: THEME.DARK,
...
import { useCallback as useCallback36, useEffect as useEffect36, useState as useState28 } from "react";
...
import React95, { memo as memo35 } from "react";
var PixelTab = memo35(
  ({
    tabList,
    height,
...
import React96, { memo as memo36 } from "react";
