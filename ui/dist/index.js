...
import {
  ...
  selector,
  RecoilRoot,
  useRecoilState as useRecoilState17,
  useRecoilValue as useRecoilValue17,
  useResetRecoilState
} from "recoil";
import {
  motion as motion4,
...
var ChainId = /* @__PURE__ */ ((ChainId12) => {
  ChainId12["Bsc"] = "56";
  ChainId12["BscTestnet"] = "97";
  ChainId12["Arbitrum"] = "42161";
  ChainId12["ArbitrumRinkeby"] = "421611";
  ChainId12["ArbitrumGoerli"] = "421613";
  ChainId12["LineaSepolia"] = "59141";
  ChainId12["LineaMainnet"] = "59144";
  ChainId12["POLYGON_MUMBAI"] = "80001";
  ChainId12["POLYGON_ZKEVM"] = "1442";
  ChainId12["ScrollAlphaTestnet"] = "534353";
  ChainId12["OPBNBTEST"] = "5611";
  ChainId12["OPBNB"] = "204";
  ChainId12["ScrollSepoliaTestnet"] = "534351";
  ChainId12["MantaPacificMainnet"] = "169";
  ChainId12["MantaPacificTestnet"] = "3441005";
  ChainId12["Combo"] = "9980";
  ChainId12["ComboTestnet"] = "91715";
  ChainId12["Mantle"] = "5000";
  ChainId12["MantleTestnet"] = "5001";
  ChainId12["Sepolia"] = "11155111";
  ChainId12["B2"] = "223";
  ChainId12["B2Testnet"] = "1123";
  ChainId12["ZytronLineaSepoliaTestnet"] = "50098";
  ChainId12["ZytronLineaMain"] = "9901";
  ChainId12["ZytronB2Testnet"] = "50097";
  ChainId12["Taiko"] = "167000";
  ChainId12["SagaMainnet"] = "2717465680371000";
  ChainId12["B3Mainnet"] = "8333";
  ChainId12["EXPTestnet"] = "18880";
  ChainId12["BaseSepolia"] = "84532";
  return ChainId12;
})(ChainId || {});
...
var BlockExplorerUrls = {
  ...
  ["84532" /* BaseSepolia */]: ["https://sepolia.basescan.org"]
};
var ChainName = {
  ["56" /* Bsc */]: "BSC Mainnet",
  ...
  ["50098" /* ZytronLineaSepoliaTestnet */]: "Zytron Testnet",
...
var zkBingoV1 = (chainId, name) => {
  ...
  try {
    ...
    if (chainId === "50098" /* ZytronLineaSepoliaTestnet */) {
      address = {
...
var WagmiWalletHandler = class {
  constructor(walletClient, gas0Balance, configApi) {
    ...
    this.address = {
      GP: zkBingoV1(this.chainId, "ZypherGameToken" /* ZypherGameToken */)
    };
  ...
  if (wallet.aa.isFree) {
    const res = await httpPost(`${wallet.aa.config.api}/functionmulticall`, {
      list: items.map((v2) => ({
        ...
        to: v2.to,
        data: v2.data,
        value: `0x${parseInt(String(v2.value), 10).toString(16)}`
      })),
      v: Number(v),
      r,
      s,
...
var TVLChainId = ((TVLChainId3) => {
  TVLChainId3[TVLChainId3["B2"] = "223" /* B2 */] = "B2";
  TVLChainId3[TVLChainId3["B2Testnet"] = "1123" /* B2Testnet */] = "B2Testnet";
  TVLChainId3[TVLChainId3["LineaMainnet"] = "59144" /* LineaMainnet */] = "LineaMainnet";
  TVLChainId3[TVLChainId3["LineaSepolia"] = "59141" /* LineaSepolia */] = "LineaSepolia";
  return TVLChainId3;
})(TVLChainId || {});
...
var L3ChainId = {
  ...
  [TVLChainId.LineaSepolia]: "50098" /* ZytronLineaSepoliaTestnet */
};
var activeTokenList = {
...
import React2, { memo as memo2, useCallback as useCallback5, useRef as useRef5 } from "react";
import styled from "styled-components";

// src/components/PixelBtn/PixelFlatBtn.tsx
import React, { memo, useCallback as useCallback4, useRef as useRef4, useState as useState6 } from "react";
...
import React3, { memo as memo3, useEffect as useEffect7, useState as useState8 } from "react";
...
import { useCallback as useCallback6, useContext, useEffect as useEffect9, useState as useState9 } from "react";
...
// src/components/Token/TokenWithChain/TokenWithChain.tsx
import React10, { memo as memo8, useMemo as useMemo5 } from "react";
import styled2 from "styled-components";
var Wrap = styled2.div`
  width: ${({ width }) => width != null ? width : 22}px;
  height: ${({ width }) => width != null ? width : 22}px;
`;
var TokenWithChain = memo8(
  ({
    token,
    chainId,
    width
  }) => {
    const { cLogo, cChainId } = useMemo5(() => {
      const _c = chainId != null ? chainId : defaultActiveChainId;
      return {
        cChainId: _c,
        cLogo: token.logoPath ? token.logoPath : CurrencyLogo[_c]
      };
    }, [JSON.stringify(token), chainId]);
    return /* @__PURE__ */ React10.createElement(Wrap, {
      className: "token_with_chain",
      width
...
var TokenWithChain_default = TokenWithChain;
...
var useGetUserInfo = () => {
  const getUserInfo = useCallback8(
...
var pointsV2DialogState = atom7({
  key: "pointsV2DialogState",
  default: false
});
var pointsV2TabIndexState = atom7({
  key: "pointsV2TabIndexState",
  default: 0
});
...
var Logo = ({ src: src6, alt, ...rest }) => {
  ...
  if (src6 && !bad) {
    return /* @__PURE__ */ React11.createElement("img", {
      decoding: "async",
      loading: "lazy",
      ...rest,
      alt,
...
var ZkBingoPointsContract = (chainId, env, address, signer) => {
  return getContract2({
    env,
    abi,
    address: address != null ? address : zkBingoV1(chainId, "points" /* Points */),
    signer,
    chainId
  });
};
        ...
        if (_index || _index === 0) {
          ...
          try {
            ...
            if (pointsList) {
              ...
              const lobbyContractAddress = zkBingoV1(
                chainId,
                "lobby" /* Lobby */
              );
...
var PoinsWarn = memo9(({ handleNext }) => {
  ...
  }, /* @__PURE__ */ React12.createElement("p", null, t("poinsWarnText01")), /* @__PURE__ */ React12.createElement("p", null, /* @__PURE__ */ React12.createElement("em", null), /* @__PURE__ */ React12.createElement("i", null, t("poinsWarnText02")), /* @__PURE__ */ React12.createElement("br", null), /* @__PURE__ */ React12.createElement("em", null), /* @__PURE__ */ React12.createElement("i", null, t("poinsWarnText03"))), /* @__PURE__ */ React12.createElement("p", null, t("poinsWarnText04")), /* @__PURE__ */ React12.createElement("p", {
    className: "points_dialog_flex",
    onClick: () => setHidePointsWarn(!hidePointsWarn)
  }, /* @__PURE__ */ React12.createElement(icons_default, {
    name: hidePointsWarn ? "checked" : "check"
  }), t("poinsWarnText05")), /* @__PURE__ */ React12.createElement(ActivePixelButtonColor, {
  ...
  }, /* @__PURE__ */ React12.createElement("p", null, t("Ok"))));
}, isEqual);
...
var PointsIcon = memo10(
  ({ isMobile: isMobile2, classname, mr }) => {
    return /* @__PURE__ */ React13.createElement(PointsImg, {
      isMobile: isMobile2,
...
var Modal = ({
  ...
  return /* @__PURE__ */ React14.createElement(DialogOverlay, {
    isOpen: open,
    onDismiss: onCancel,
    className: classnames3("customDialog", "bottom", wrapClassName),
    "aria-label": "Modal"
  }, /* @__PURE__ */ React14.createElement(DialogContent, {
    style: { width }
  }, children));
};
...
var PixelTableBorder = memo11(
  ({
    ...
    return /* @__PURE__ */ React15.createElement(PixelBorderCard, {
...
var IsTablePixelWidget = memo11(
  ({
    ...
    const isW768 = useIsW768();
    return isW768 ? /* @__PURE__ */ React15.createElement("div", {
      className
    }, header_children, body_children) : /* @__PURE__ */ React15.createElement(PixelTable, {
      width,
      height,
      className,
      backgroundColor,
...
var LoadingButton = memo12(
  ({
    ...
    if (isLoading) {
      return /* @__PURE__ */ React16.createElement(SvgComponent_default, {
...
var DialogClose = memo13(({ onClick, ...props }) => {
...
var PointsDialog = memo14(
  ({ env, setSuccessToast, setErrorToast }) => {
    ...
    }, /* @__PURE__ */ React18.createElement(PixelTable, {
      classNameHeader: "modalTitleInner",
      backgroundColor: "#1D263B",
      header_children: /* @__PURE__ */ React18.createElement("p", {
        className: "modalTitleInnerTitle"
      }, t("Recharge Points")),
      body_children: /* @__PURE__ */ React18.createElement(React18.Fragment, null, /* @__PURE__ */ React18.createElement("div", {
        className: "modalMain"
      }, pointsWarn === 1 ? /* @__PURE__ */ React18.createElement(PointsWarn_default, {
        isLoading,
        handleNext: swapPointHandle
      }) : isLoading ? /* @__PURE__ */ React18.createElement(IsLoading, null) : /* @__PURE__ */ React18.createElement(React18.Fragment, null, /* @__PURE__ */ React18.createElement("div", {
        className: "balanceTitle"
      }, /* @__PURE__ */ React18.createElement("p", null, t("Balance"), ": ", /* @__PURE__ */ React18.createElement("strong", null, pointsBalanceStr)), /* @__PURE__ */ React18.createElement(PointsIcon, {
        isMobile: isMobile2,
        classname: "pointsIcon"
      })), /* @__PURE__ */ React18.createElement(PointsTable, {
        pointsList,
        chainId,
        onClick: swapPointHandle
      })))),
      pixel_height: 10
    }), /* @__PURE__ */ React18.createElement(DialogClose_default, {
      onClick: handleCancel
    }));
  },
  isEqual
);
var IsLoading = memo14(() => {
  const { t } = useCustomTranslation([LngNs.points]);
  return /* @__PURE__ */ React18.createElement("div", {
    className: "loading"
  }, /* @__PURE__ */ React18.createElement(LoadingButton_default, {
    isLoading: true,
    className: "loading_size4"
  }), /* @__PURE__ */ React18.createElement("p", null, t("IsLoadingText1")));
}, isEqual);
var PointsTable = memo14(
  ({ pointsList, chainId, onClick }) => {
    return /* @__PURE__ */ React18.createElement("div", {
      className: "table"
    }, pointsList.map((v, index) => /* @__PURE__ */ React18.createElement(PixelBorderCardButton, {
      pixel_height: 4,
    ...
    }, /* @__PURE__ */ React18.createElement("h3", null, v.pointAmountStr), /* @__PURE__ */ React18.createElement("img", {
      decoding: "async",
      loading: "lazy",
      className: "points_img",
      src: preStaticUrl + `/img/points/points_${v.index}.png`,
      alt: "points"
    }), /* @__PURE__ */ React18.createElement(ActivePixelCard, {
      backgroundColor: "#1649FF",
      className: "bottom",
      pixel_height: 4
    }, /* @__PURE__ */ React18.createElement("p", null, v.priceStr), /* @__PURE__ */ React18.createElement(CurrencyLogo_default, {
      className: "img",
      src: CurrencyLogo[chainId || 97]
    })), v.discount && /* @__PURE__ */ React18.createElement("div", {
      className: "discount"
      ...
      alt: "points"
    }), /* @__PURE__ */ React18.createElement("p", null, v.discount, "% ", /* @__PURE__ */ React18.createElement("br", null), "OFF"))))));
  },
  isEqual
);
...
import React24, { memo as memo20, useMemo as useMemo8 } from "react";

// src/components/SideBar/component/CommunityLink.tsx
import React19, { memo as memo15 } from "react";
var CommunityLink = memo15(({ className }) => {
...
var LinkItem1 = memo16(
  ({
    ...
    })), /* @__PURE__ */ React20.createElement("p", null, link.label));
  },
  isEqual
);
...
var SideBarGamesList = memo17(
  ({
    ...
    return /* @__PURE__ */ React21.createElement("div", {
      className: "gamelist"
    }, /* @__PURE__ */ React21.createElement(ActivePixelCard, {
...
import React22, { memo as memo18 } from "react";
var SideBarTitle = memo18(
...
var SideBarTitleLink = memo18(
  ({ logo_url_name, link, className, logo_title }) => {
    ...
    }), /* @__PURE__ */ React22.createElement("p", null, t(logo_title)), logo_url_name ? /* @__PURE__ */ React22.createElement("img", {
      decoding: "async",
      loading: "lazy",
      src: logo_url_name,
      title: t(logo_title)
...
var Navigation = memo19(
  ({ pathname, Link }) => {
    const [chooseIndex, setChooseIndex] = useState14(
      null
    );
    ...
    ).map((v, index) => /* @__PURE__ */ React23.createElement(LinkComp, {
      Link,
      item: v,
      key: v.label,
    ...
    }, v.label, v.icon ? /* @__PURE__ */ React23.createElement("img", {
      decoding: "async",
      loading: "lazy",
      src: v.icon,
      alt: "pixel_link",
...
// src/components/SideBar/SideBar.tsx
var ZypherLogo = memo20(
  ({ Link, isMobile: isMobile2 }) => {
    return /* @__PURE__ */ React24.createElement(LinkComp2, {
      Link,
      href: "/",
...
var LinkComp2 = memo20(
  ({
    ...
    if (Link) {
      return /* @__PURE__ */ React24.createElement(Link, {
        to: href,
        className
      }, children);
    }
...
var SideBar = (props) => {
  ...
  return /* @__PURE__ */ React24.createElement("div", {
    ...
    (v) => {
      var _a;
      return /* @__PURE__ */ React24.createElement(SideBarTitleLink, {
        key: v.label,
        logo_title: v.label,
  ...
  ), /* @__PURE__ */ React24.createElement(SideBarTitle, {
    logo_title: "Games",
    logo_url_name: "pixel_games",
    className: "sideBarTitle mt40"
  }), /* @__PURE__ */ React24.createElement(SideBarGamesList_default, {
  ...
  }), /* @__PURE__ */ React24.createElement(Language_default, {
    type: "list"
  })), /* @__PURE__ */ React24.createElement("div", {
  ...
  }), /* @__PURE__ */ React24.createElement(CommunityLink_default, {
...
import React25, { memo as memo21 } from "react";
var DivWrap = memo21(
  ({
    className,
    showDiv,
    ...
    return showDiv ? /* @__PURE__ */ React25.createElement("div", {
      className
    }, " ", children) : /* @__PURE__ */ React25.createElement(React25.Fragment, null, children);
  },
  isEqual
);
...
import React45, { memo as memo37 } from "react";

// src/components/ConnectWallet/components/Balance/Balance.tsx
import { SyncOutlined } from "@ant-design/icons";
import React28, { memo as memo24, useCallback as useCallback18, useEffect as useEffect14, useMemo as useMemo9, useState as useState15 } from "react";
...
import React27, { memo as memo23, useCallback as useCallback16, useEffect as useEffect13 } from "react";

// src/components/ConnectWallet/components/PointsDialog/GetPointsSuccess.tsx
import React26, { memo as memo22 } from "react";
import { useRecoilState as useRecoilState7 } from "recoil";
var GetPointsSuccess = memo22(() => {
...
// src/components/ConnectWallet/components/Balance/balanceItem.tsx
import { useRecoilState as useRecoilState8, useSetRecoilState as useSetRecoilState10 } from "recoil";
var BalanceItem = memo23(
  ({
    className,
    loading,
    balanceStr,
    ...
    return /* @__PURE__ */ React27.createElement(IsPixelWidget_default, {
...
var BalanceCountUpItem = memo23(
  ({
    ...
    return /* @__PURE__ */ React27.createElement(IsPixelWidget_default, {
      ...
      duration: 1.5,
      showDiv: false
    }) : balanceStr, logo), /* @__PURE__ */ React27.createElement(GetPointsSuccess_default, null));
  },
  isEqual
);
...
// src/components/ConnectWallet/hooks/useToFaucet.ts
...
var Balance = memo24((props) => {
  ...
  const fetchErc20Balance = useCallback18(async () => {
    ...
    try {
      const pointsAddress = zkBingoV1(chainId, "ZypherGameToken" /* ZypherGameToken */);
  ...
  return /* @__PURE__ */ React28.createElement(React28.Fragment, null, isMiddleWidth ? null : /* @__PURE__ */ React28.createElement(IsPixelWidget_default, {
    className: "refresh_balance  refresh_balance_pixel",
    onClick: fetchBalanceOf
  }, /* @__PURE__ */ React28.createElement(SyncOutlined, null)), DPSupportChainId.includes(chainId) ? /* @__PURE__ */ React28.createElement(BalanceCountUpItem, {
    onClick: showPointsModal,
    logo: /* @__PURE__ */ React28.createElement(PointsIcon, {
    ...
    CountUpNumber,
    preChild: /* @__PURE__ */ React28.createElement(AddIcon, {
      name: PointV2 ? "pixel_switch_02" : "pixel_add",
      isMobile: isMiddleWidth
    }),
    balanceStr: pointsBalanceStr
  }) : null, !isMiddleWidth && /* @__PURE__ */ React28.createElement(React28.Fragment, null, /* @__PURE__ */ React28.createElement(balanceItem_default, {
    logo: /* @__PURE__ */ React28.createElement(CurrencyLogo_default, {
    ...
    loading,
    className: props.className
  }), chainId === "18880" /* EXPTestnet */ ? /* @__PURE__ */ React28.createElement(balanceItem_default, {
    logo: /* @__PURE__ */ React28.createElement(CurrencyLogo_default, {
...
import React29, { memo as memo25, useCallback as useCallback19 } from "react";
...
`;
var ChainSelectorWidget = memo25(({ className, direction_type }) => {
  const { chainId } = useActiveWeb3React();
  const isMobile2 = useIsW768();
  ...
  return chainId ? /* @__PURE__ */ React29.createElement(IsPixelWidget_default, {
...
import React30, { useCallback as useCallback20 } from "react";
...
var PointsRuleDialog = () => {
  ...
  return /* @__PURE__ */ React30.createElement(React30.Fragment, null, /* @__PURE__ */ React30.createElement(DialogOverlay2, {
    isOpen: isModalOpen,
    onDismiss: handleCancel,
    className: "points_dialog_zindex"
  }, /* @__PURE__ */ React30.createElement(DialogContent2, {
    className: "points_dialog_dialogContent"
  }, /* @__PURE__ */ React30.createElement(PixelTable, {
    backgroundColor: "#1D263B",
    header_children: /* @__PURE__ */ React30.createElement("p", {
      className: "modalTitleInnerTitle"
    }, t("Rules")),
    body_children: /* @__PURE__ */ React30.createElement(React30.Fragment, null, /* @__PURE__ */ React30.createElement("div", {
      className: "points_dialog_dialogContainer"
    }, /* @__PURE__ */ React30.createElement("h4", null, t("PointsRuleText01")), /* @__PURE__ */ React30.createElement("p", null, t("PointsRuleText02")), /* @__PURE__ */ React30.createElement("p", null, /* @__PURE__ */ React30.createElement("em", null), /* @__PURE__ */ React30.createElement("i", null, t("PointsRuleText03")), /* @__PURE__ */ React30.createElement("br", null), /* @__PURE__ */ React30.createElement("em", null), /* @__PURE__ */ React30.createElement("i", null, t("PointsRuleText04")), /* @__PURE__ */ React30.createElement("br", null), /* @__PURE__ */ React30.createElement("em", null), /* @__PURE__ */ React30.createElement("i", null, t("PointsRuleText04")), /* @__PURE__ */ React30.createElement("br", null), /* @__PURE__ */ React30.createElement("em", null), " ", /* @__PURE__ */ React30.createElement("i", null, t("PointsRuleText06"))), /* @__PURE__ */ React30.createElement("p", null, /* @__PURE__ */ React30.createElement(Trans, {
      i18nKey: "PointsRuleText07",
      defaults: t("PointsRuleText07"),
      values: { Link: t("Link") },
      components: { bold: /* @__PURE__ */ React30.createElement("strong", null) }
    })), /* @__PURE__ */ React30.createElement("h4", null, t("PointsRuleText09")), /* @__PURE__ */ React30.createElement("p", null, /* @__PURE__ */ React30.createElement(Trans, {
      ...
      rel: "noreferrer"
    }, "Discord")))), /* @__PURE__ */ React30.createElement("div", {
      className: "points_dialog_btnWrap"
    }, /* @__PURE__ */ React30.createElement(ActivePixelButtonColor, {
      themeType: "brightBlue",
      onClick: handleCancel,
      width: "340px",
      height: "52px",
    ...
    pixel_height: 10
  }), /* @__PURE__ */ React30.createElement(DialogClose_default, {
    onClick: handleCancel
  }))));
};
...
import React37, { memo as memo30, useCallback as useCallback25 } from "react";

// src/components/PlayerAvatar/index.tsx
import cx from "classnames";
import React32, { memo as memo26, useMemo as useMemo10 } from "react";
...
var Avatar = ({
  ...
  return /* @__PURE__ */ React31.createElement(IsPixelWidgetStyled, {
    hidePixel,
    size,
    style,
    backgroundColor
...
import { useCallback as useCallback21, useEffect as useEffect15, useState as useState16 } from "react";
import { atom as atom10, useRecoilState as useRecoilState10, useRecoilValue as useRecoilValue12 } from "recoil";
...
var useAvatar = (account, hideAvatars) => {
  var _a;
  const [avatars2, setAvatars] = useRecoilState10(avatarState);
...
// src/components/PlayerAvatar/index.tsx
var PlayerAvatar = memo26(
  ({
    account,
    showAccount = false,
    size = 60,
    border = false,
    AvatarBorder = React32.Fragment,
    AccountTextFrComp = React32.Fragment,
    className,
    preLen,
    endLen,
    otherStr,
    ...
    return /* @__PURE__ */ React32.createElement("div", {
      ...
      onClick,
      onMouseOver
    }, hideAvatars ? null : aa_mm_address ? aa_mm_address ? /* @__PURE__ */ React32.createElement(AvatarBorder, null, /* @__PURE__ */ React32.createElement(Avatar_default, {
      hidePixel,
      size,
      src: avatars2.selectedAvatar,
      backgroundColor: avatars2.selectedBackground
    })) : null : /* @__PURE__ */ React32.createElement(AvatarBorder, null, /* @__PURE__ */ React32.createElement("div", {
    ...
    }, avatarText, /* @__PURE__ */ React32.createElement(AccountTextFrComp, null)));
  }
);
...
var PlayerAvatarList = ({
  ...
  return /* @__PURE__ */ React32.createElement(OuterCircle, {
    size,
    isGreen,
    isGrey,
    winner
  ...
  }, aa_mm_address ? /* @__PURE__ */ React32.createElement("img", {
    decoding: "async",
    loading: "lazy",
    width: "100%",
    height: "100%",
...
import React36, { memo as memo29, useCallback as useCallback24, useEffect as useEffect16, useState as useState17 } from "react";
...
import React33, { createContext as createContext2, useContext as useContext2, useMemo as useMemo11 } from "react";
...
function RainbowKitChainProvider({
  ...
  return /* @__PURE__ */ React33.createElement(RainbowKitChainContext.Provider, {
    value: useMemo11(
      () => ({
        chains,
...
import React34, { memo as memo27, useCallback as useCallback22 } from "react";
var DialogTitle = memo27(
  ({ label, setDialogOpen, children, classNames }) => {
    const closeHandle = useCallback22(() => {
      setDialogOpen(false);
    }, [setDialogOpen]);
    ...
    }, label), children ? children : null, /* @__PURE__ */ React34.createElement("span", {
      onClick: closeHandle
    }, /* @__PURE__ */ React34.createElement(icons_default, {
      name: "close"
    })));
  }
);
...
import React35, { memo as memo28, useCallback as useCallback23, useMemo as useMemo13 } from "react";
import { useDisconnect } from "wagmi";
import { useRecoilState as useRecoilState11 } from "recoil";
var MUserInfo = memo28(({ account, chainId, copy, cancel }) => {
  ...
  return /* @__PURE__ */ React35.createElement("div", {
    ...
    direction_type: "userPop",
    className: classnames8("m_user_chain")
...
var AddressMiddleWrapPop = memo29(({ copy }) => {
  ...
  return /* @__PURE__ */ React36.createElement("div", {
  ...
  }), chainId === "18880" /* EXPTestnet */ ? /* @__PURE__ */ React36.createElement(BalanceItem2, {
    logo: /* @__PURE__ */ React36.createElement(CurrencyLogo_default, {
      className: "balance_item_faucet",
      src: `${preStaticUrl}/img/icon/faucet.svg`
    }),
    ...
    balanceStr: "",
    onClick: toPath
  }) : null), /* @__PURE__ */ React36.createElement(Language_default, {
    type: "list"
  }), /* @__PURE__ */ React36.createElement(AddressWrapPopItem, {
    iconName: "pixel_blockchain",
    label: "Blockchain Explorer",
...
import React44, { memo as memo36, useCallback as useCallback29 } from "react";
import { useRecoilState as useRecoilState14 } from "recoil";

// src/components/Modal/ModalWithMotion/ModalWithMotion.tsx
import React38 from "react";
import { DialogContent as DialogContent3, DialogOverlay as DialogOverlay3 } from "@reach/dialog";
...
var ModalWithMotion = ({
  ...
  return /* @__PURE__ */ React38.createElement(DialogOverlay3, {
    className: overlayClassName,
    isOpen,
    onDismiss
  }, /* @__PURE__ */ React38.createElement(motion3.div, {
    variants: dialogVariants,
    initial: "hidden",
    animate: isOpen ? "visible" : "hidden",
    exit: "hidden"
  }, /* @__PURE__ */ React38.createElement(DialogContent3, {
...
import React42, { memo as memo34, useCallback as useCallback26, useEffect as useEffect17, useMemo as useMemo14, useState as useState18 } from "react";

// src/components/Staking/GP/components/fromToken.tsx
import React39, { memo as memo31 } from "react";
var FromToken = memo31(
  ({
    label,
    balanceStr,
    chainId,
    ...
    return /* @__PURE__ */ React39.createElement(React39.Fragment, null, /* @__PURE__ */ React39.createElement("div", {
      className: "S_staking_token_detail"
    }, /* @__PURE__ */ React39.createElement("p", {
      className: "S_staking_token_detail_fl"
    }, label), /* @__PURE__ */ React39.createElement("div", {
      className: "S_staking_token_detail_fr"
    }, /* @__PURE__ */ React39.createElement("p", {
      className: "S_staking_token_detail_balance"
    }, "Balance: ", balanceStr), /* @__PURE__ */ React39.createElement(TokenWithChain_default, {
      chainId,
      token
    }), /* @__PURE__ */ React39.createElement(ActivePixelButton, {
      ...
      pixel_height: 2,
      onClick: maxHandle
    }, /* @__PURE__ */ React39.createElement("p", null, "MAX")))), /* @__PURE__ */ React39.createElement(PixelBorderCard, {
      ...
      backgroundColor: "#1649FF",
      pixel_height: 6
    }, /* @__PURE__ */ React39.createElement(TokenWithChain_default, {
      chainId,
      token,
      width: 30
    }), /* @__PURE__ */ React39.createElement("p", null, token.symbol))));
  },
  isEqual
);
var fromToken_default = FromToken;

// src/components/Staking/GP/components/toToken.tsx
...
var ToToken = memo32(
  ({
    ...
    return /* @__PURE__ */ React40.createElement(React40.Fragment, null, /* @__PURE__ */ React40.createElement("div", {
      className: "S_staking_token_detail"
    }, /* @__PURE__ */ React40.createElement("p", {
      className: "S_staking_token_detail_fl"
    }, label)), /* @__PURE__ */ React40.createElement(PixelBorderCard, {
      className: "W_staking_input",
      width: "100%",
      height: isW768 ? "44px" : "58px",
      pixel_height: 6,
      ...
      value,
      disabled: inputDisabled
    }), /* @__PURE__ */ React40.createElement(ActivePixelButton, {
      className: "W_staking_input_btn",
      backgroundColor: "#1649FF",
      pixel_height: 6
...
var toToken_default = ToToken;

// src/components/Staking/GP/components/details.tsx
import React41, { memo as memo33 } from "react";
var Detail = memo33(
  () => {
    return /* @__PURE__ */ React41.createElement(React41.Fragment, null, /* @__PURE__ */ React41.createElement("li", null, /* @__PURE__ */ React41.createElement("p", null, "Exchange rate"), /* @__PURE__ */ React41.createElement("div", {
      className: "S_fr"
    }, /* @__PURE__ */ React41.createElement("p", null, "1 ETH = 2,000,000 GP"))));
  },
  () => {
    return false;
  }
);
var details_default = Detail;

// src/components/Staking/GP/components/GPDeposit.tsx
import { useRecoilValue as useRecoilValue13 } from "recoil";
var GPDeposit = memo34(
  ({
    NativeToken,
    GPToken,
    deposit,
    ...
    const [depositValue, setDepositValue] = useState18("");
    const [receiveValue, setReceiveValue] = useState18("");
    const { chainId } = useActiveWeb3React();
    const nativeBalance = useRecoilValue13(nativeBalanceState);
    const nativeBalanceStr = useNativeBalanceStr();
    const isW768 = useIsW768();
    useEffect17(() => {
      if (health == null ? void 0 : health.minDeposit) {
        const amount = new BigNumberJs_default(health.minDeposit).dividedBy(divisorBigNumber).toFixed();
        const value = new BigNumberJs_default(amount).dividedBy(ChainPointPrice[chainId]).toFixed();
        setDepositValue(amount);
        setReceiveValue(value);
      }
    }, [Boolean(!!(health == null ? void 0 : health.minDeposit))]);
    ...
    const isDisable = useMemo14(() => {
      return loadingDeposit || ![depositValue, receiveValue].every(
        (val) => !isNaN(Number(val)) && Number(val) > 0
      );
    }, [loadingDeposit, depositValue, receiveValue]);
    const { btnLabel, isBalanceEnough } = useMemo14(() => {
      const obj = {
      ...
      if ([depositValue, receiveValue].every(
        ...
        if (chainId) {
          if (GPV2SupportChainId.includes(chainId)) {
            if (new BigNumberJs_default(nativeBalance).gte(depositValue)) {
    ...
    return /* @__PURE__ */ React42.createElement(React42.Fragment, null, NativeToken ? /* @__PURE__ */ React42.createElement(fromToken_default, {
      label: "Deposit",
      balanceStr: nativeBalanceStr,
      chainId,
      token: NativeToken,
      ...
      value: depositValue
    }) : null, /* @__PURE__ */ React42.createElement(SvgComponent_default, {
      className: "S_arr_down",
      src: preStaticUrl + "/img/icon/pixel_arrow_down02.svg"
    }), GPToken ? /* @__PURE__ */ React42.createElement(toToken_default, {
      label: "Receive",
      chainId,
      token: GPToken,
      onChange: receiveInputHandle,
      value: receiveValue
    }) : null, /* @__PURE__ */ React42.createElement("ul", {
      className: "S_text_li"
    }, /* @__PURE__ */ React42.createElement("li", null, /* @__PURE__ */ React42.createElement("p", null, "Minimum deposit amount"), /* @__PURE__ */ React42.createElement("div", {
      className: "S_fr"
    }, /* @__PURE__ */ React42.createElement("p", null, health == null ? void 0 : health.minDepositStr, " ETH"))), /* @__PURE__ */ React42.createElement(details_default, null)), /* @__PURE__ */ React42.createElement(ActivePixelButtonColor, {
      className: "W_staking_confirm",
      width: "100%",
      height: isW768 ? "48px" : "54px",
      pixel_height: 5,
      disable: isDisable || !isBalanceEnough,
      onClick: () => deposit && deposit({ nativeValue: depositValue, GPValue: receiveValue }),
      themeType: "brightBlue"
    }, /* @__PURE__ */ React42.createElement("p", null, btnLabel), /* @__PURE__ */ React42.createElement(LoadingButton_default, {
...
import React43, { memo as memo35, useCallback as useCallback27, useEffect as useEffect18, useMemo as useMemo15, useState as useState19 } from "react";
import { useRecoilValue as useRecoilValue14 } from "recoil";
var GPWithdraw = memo35(
  ({
    NativeToken,
    GPToken,
    withdraw,
    ...
    const [isL2, setIsL2] = useState19(false);
    useEffect18(() => {
      if (chainId) {
        setIsL3(
    ...
    const { btnLabel, isBalanceEnough } = useMemo15(() => {
      ...
      if ([depositValue, receiveValue].every(
        ...
        if (chainId) {
          if (GPV2SupportChainId.includes(chainId)) {
            const tokenAmount = new BigNumberJs_default(depositValue).times(divisorBigNumber).toFixed();
            if (allowance && new BigNumberJs_default(pointBalance).gte(depositValue)) {
              obj.isBalanceEnough = true;
              if (new BigNumberJs_default(allowance).lt(tokenAmount)) {
                obj.isApprove = false;
    ...
    useEffect18(() => {
      if (chainId && (health == null ? void 0 : health.minWithdraw)) {
        ...
        const value = new BigNumberJs_default(amount).times(ChainPointPrice[chainId]).toFixed();
        setDepositValue(amount);
        setReceiveValue(value);
      }
    }, [Boolean(!!(health == null ? void 0 : health.minWithdraw))]);
    return /* @__PURE__ */ React43.createElement(React43.Fragment, null, GPToken && chainId ? /* @__PURE__ */ React43.createElement(fromToken_default, {
      label: "Withdraw",
      balanceStr: pointsBalanceStr,
      chainId,
      token: GPToken,
      ...
      value: depositValue,
      inputDisabled: isL2
    }) : null, /* @__PURE__ */ React43.createElement(SvgComponent_default, {
      className: "S_arr_down",
      src: preStaticUrl + "/img/icon/pixel_arrow_down02.svg"
    }), NativeToken && chainId ? /* @__PURE__ */ React43.createElement(toToken_default, {
      label: "Receive",
      chainId,
      token: NativeToken,
      onChange: receiveInputHandle,
      value: receiveValue,
      inputDisabled: isL2
    }) : null, /* @__PURE__ */ React43.createElement("ul", {
      className: "S_text_li S_text_li_column"
    }, /* @__PURE__ */ React43.createElement("li", null, /* @__PURE__ */ React43.createElement("p", null, "Minimum withdraw amount"), /* @__PURE__ */ React43.createElement("div", {
      className: "S_fr"
    }, /* @__PURE__ */ React43.createElement("p", null, health == null ? void 0 : health.minWithdrawStr, " GP"))), /* @__PURE__ */ React43.createElement(details_default, null), /* @__PURE__ */ React43.createElement("li", null, /* @__PURE__ */ React43.createElement("p", null, "Withdraw free"), /* @__PURE__ */ React43.createElement("div", {
      className: "S_fr_column"
    }, /* @__PURE__ */ React43.createElement("p", {
      className: "S_fr_yellow"
    }, "0.1%"), /* @__PURE__ */ React43.createElement("p", {
      className: "S_fr_grey"
    }, withdrawFree))), /* @__PURE__ */ React43.createElement("li", null, /* @__PURE__ */ React43.createElement("p", null, "Actual amount received"), /* @__PURE__ */ React43.createElement("div", {
      className: "S_fr"
    }, /* @__PURE__ */ React43.createElement("p", null, actualReceived, " ", chainId && Currency[chainId] ? Currency[chainId] : "-"))), !isDisable && depositValue && actualReceived === "-" ? /* @__PURE__ */ React43.createElement("li", null, /* @__PURE__ */ React43.createElement("p", null), /* @__PURE__ */ React43.createElement("div", {
      className: "S_fr_column"
    }, /* @__PURE__ */ React43.createElement("p", {
      className: "S_fr_yellow"
    }, "The operation is too frequent. Please try again later."))) : null), /* @__PURE__ */ React43.createElement(ActivePixelButtonColor, {
      className: "W_staking_confirm",
      width: "100%",
      height: isW768 ? "48px" : "54px",
      pixel_height: 5,
      ...
      themeType: "brightBlue"
    }, /* @__PURE__ */ React43.createElement("p", null, btnLabel), /* @__PURE__ */ React43.createElement(LoadingButton_default, {
...
import { useCallback as useCallback28, useEffect as useEffect19, useMemo as useMemo16, useState as useState20 } from "react";
...
var ZgClient_default = [
  ...
  },
  {
    ...
    name: "InsufficientGpBalance",
    type: "error"
  },
  {
    inputs: [
      {
        internalType: "enum ZgMeta.AdminError",
        name: "adminError",
        type: "uint8"
      }
    ],
  ...
  },
  {
    ...
    name: "OverMaxWithdraw",
    type: "error"
  },
  {
    inputs: [
      {
        internalType: "enum ZgMeta.ErrorType",
        name: "errorType",
        type: "uint8"
      }
    ],
    ...
    outputs: [
      {
        components: [
          ...
          {
            internalType: "enum ZgMeta.GP_Handling",
            name: "gpHandling",
            type: "uint8"
          },
          {
        ...
        internalType: "struct ZgMeta.HealthCheckResponse",
        name: "",
        type: "tuple"
      }
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct ZgMeta.WithdrawResponse",
        name: "",
        type: "tuple"
      }
    ],
...
// src/components/Staking/GP/contract/ZgClient.ts
var ZgClientContract = ({
  chainId,
  env,
  signer
}) => {
...
import { useRecoilState as useRecoilState13, useRecoilValue as useRecoilValue15, useSetRecoilState as useSetRecoilState14 } from "recoil";
...
var useGPDeposit = ({
  ...
  const { waitForTransaction: waitForTransaction2 } = usePublicNodeWaitForTransaction(env);
  const [refreshBalance, setRefreshBalanceState] = useRecoilState13(refreshBalanceState);
  const [loadingDeposit, setIsLoadingDeposit] = useState20(false);
  ...
  const { NativeToken, GPToken } = useMemo16(() => {
    if (chainId) {
      ...
      return {
        ...
        GPToken: {
          index: 2,
          address: zkBingoV1(chainId, "ZypherGameToken" /* ZypherGameToken */),
          symbol: "GP",
    ...
    if (chainId && GPV2SupportChainId.includes(chainId) && account) {
      ...
      if (zgClient) {
        ...
        setHealth({
          ...
          ethLiquidity: health2["ethLiquidity"].toString(),
          exchangeRate: health2["exchangeRate"].toString(),
          feeWithdraw: health2["feeWithdraw"].toString(),
          gpHandling: health2["gpHandling"].toString(),
          gpLiquidity: health2["gpLiquidity"].toString(),
          liquidityRatio: health2["liquidityRatio"].toString(),
          maxWithdraw: health2["maxWithdraw"].toString(),
          minDeposit: health2["minDeposit"].toString(),
          minDepositStr: formatMoney(
            new BigNumberJs_default(health2["minDeposit"].toString()).dividedBy(divisorBigNumber).toFixed(),
            8
          ),
          minWithdraw: health2["minWithdraw"].toString(),
          minWithdrawStr: formatMoney(
            new BigNumberJs_default(health2["minWithdraw"].toString()).dividedBy(divisorBigNumber).toFixed(),
            8
          ),
          maxWithdrawStr: formatMoney(
            new BigNumberJs_default(health2["maxWithdraw"].toString()).dividedBy(divisorBigNumber).toFixed(),
            8
          ),
          timestamp: health2["timestamp"].toString()
        });
      }
  ...
  const deposit = useCallback28(
    async ({
      ...
      try {
        if (new BigNumberJs_default(nativeValue).gt(nativeBalance)) {
          throw new Error("Amount is not enough");
        }
        const tokenAmount = new BigNumberJs_default(nativeValue).times(divisorBigNumber).toFixed();
        if (health) {
          if (new BigNumberJs_default(health.minDeposit).gt(tokenAmount)) {
            throw new Error(
  ...
  const withdraw = useCallback28(
    async ({
      ...
      setIsLoadingWithdraw(true);
      try {
        if (new BigNumberJs_default(GPValue).gt(pointBalance)) {
          throw new Error("Amount is not enough");
        }
        ...
        if (health) {
          ...
          if (new BigNumberJs_default(health.maxWithdraw).lt(tokenAmount)) {
            throw new Error(
              `Withdraw value is below the maxWithdraw required amount (${health.maxWithdrawStr}) GP.`
            );
          }
        }
        if (new BigNumberJs_default(allowance2.toString()).lt(tokenAmount)) {
          ...
          await waitForTransaction2({ confirmations: 2, hash: approveTxnHash });
...
// src/components/Staking/GP/PointsV2Dialog.tsx
var tabTitleArr = ["Deposit", "Withdraw"];
var PointsV2Dialog = memo36(
  ({ env, setSuccessToast, setErrorToast }) => {
    const [tabIndex, setTabIndex] = useRecoilState14(pointsV2TabIndexState);
    const [pointsV2DialogOpen, setPointsV2DialogOpen] = useRecoilState14(pointsV2DialogState);
    ...
    return /* @__PURE__ */ React44.createElement(ModalWithMotion_default, {
      isOpen: pointsV2DialogOpen,
      onDismiss: () => setPointsV2DialogOpen(false),
      contentClassName: classnames10("customDialog", "bottom", "dialog")
    }, /* @__PURE__ */ React44.createElement(PixelBorderCard, {
      hidePixel: isW768 ? true : false,
      width: "505px",
      className: "W_staking_staking S_staking",
      pixel_height: 9,
      backgroundColor: "#1D263B"
    }, /* @__PURE__ */ React44.createElement(PixelCube2, {
      className: "SS_tab",
      pixel_height: 4,
      height: isW768 ? "36px" : "44px",
      backgroundColor: "#1D263B",
      borderColor: "#1649FF"
    }, tabTitleArr.map((v, index) => /* @__PURE__ */ React44.createElement("div", {
      className: `SS_tab_li  ${index === tabIndex ? "on" : ""}`,
      key: v,
      onClick: () => changeTableHandle(index)
    }, /* @__PURE__ */ React44.createElement("p", null, v)))), tabIndex === 0 ? /* @__PURE__ */ React44.createElement(GPDeposit_default, {
      NativeToken,
      GPToken,
      deposit,
      loadingDeposit,
      health
    }) : /* @__PURE__ */ React44.createElement(GPWithdraw_default, {
      NativeToken,
      GPToken,
      withdraw,
      loadingWithdraw,
      ...
      health,
      getWithdrawETH
    }), /* @__PURE__ */ React44.createElement(DialogClose_default, {
      onClick: handleCancel
    })));
  },
  isEqual
);
var PointsV2Dialog_default = PointsV2Dialog;
...
var Account2 = memo37(
  ({
    ...
    return /* @__PURE__ */ React45.createElement(React45.Fragment, null, /* @__PURE__ */ React45.createElement(Balance_default, {
      isMiddleWidth,
      CountUpNumber,
      env,
      showPointsModal
    }), /* @__PURE__ */ React45.createElement(AccountInfo_default, {
      isMiddleWidth,
      isW768,
      copy,
      env
    }), !isMiddleWidth && /* @__PURE__ */ React45.createElement(ChainSelectorWidget_default, null), /* @__PURE__ */ React45.createElement(PointsDialog_default, {
      env,
      setSuccessToast,
      setErrorToast
    }), /* @__PURE__ */ React45.createElement(PointsV2Dialog_default, {
      env,
      setSuccessToast,
      setErrorToast
    }), /* @__PURE__ */ React45.createElement(PointsRuleDialog_default, null));
  },
  isEqual
);
...
import React46, { memo as memo38, useCallback as useCallback30, useEffect as useEffect20, useMemo as useMemo17 } from "react";
...
var DialogButton = styled8.div`
  ...
  align-items: center;
`;
var Text = styled8.div`
  color: #fff;
  text-align: center;
  font-size: 14px;
  padding-top: 30px;
`;
var LinkToBetaDialog = memo38(() => {
  const { t } = useCustomTranslation([LngNs.common]);
  const [linkToBetaDialogOpen, setLinkToBetaDialogOpen] = useRecoilState15(
    linkToBetaDialogState
  );
  const [linkToBetaDialogChainId, setLinkToBetaDialogChainId] = useRecoilState15(
    linkToBetaDialogChainIdState
  );
  const isMobile2 = useIsW768();
  const ToUrlName = useMemo17(() => {
  ...
  const handleButtonClick = useCallback30(() => {
  ...
  return /* @__PURE__ */ React46.createElement(Modal_default, {
    open: linkToBetaDialogOpen,
    onCancel: () => setLinkToBetaDialogOpen(false),
    footer: null,
    wrapClassName: classnames11("customDialog"),
    destroyOnClose: true,
    closable: false,
    width: isMobile2 ? "100%" : 360,
    centered: isMobile2 ? false : true
  }, /* @__PURE__ */ React46.createElement(DialogTitle_default, {
    label: t("Switch Networks"),
    setDialogOpen: setLinkToBetaDialogOpen,
    classNames: isMobile2 ? "modalTitleInner" : ""
  }), /* @__PURE__ */ React46.createElement(Content, null, /* @__PURE__ */ React46.createElement(WarningOutlined, {
    style: { color: "#1649FF", fontSize: "50px" }
  }), /* @__PURE__ */ React46.createElement(Text, null, linkToBetaDialogChainId === "9980" /* Combo */ ? "Combo is currently only deployed in 2048." : t("linkToBeta", {
  ...
  }, /* @__PURE__ */ React46.createElement(DialogButton, {
...
import React101, { useEffect as useEffect36, useMemo as useMemo23 } from "react";
...
import React96, { memo as memo39 } from "react";
import { useSetRecoilState as useSetRecoilState16 } from "recoil";
...
import React62, { useCallback as useCallback35, useEffect as useEffect29, useState as useState24 } from "react";
...
var Box = React48.forwardRef(
  ({ as = "div", className, testId, ...props }, ref) => {
    ...
    return React48.createElement(as, {
...
import React60, { createContext as createContext10, useContext as useContext5 } from "react";
...
import React49, { createContext as createContext4, useContext as useContext4, useEffect as useEffect23, useState as useState22 } from "react";
...
function TransactionStoreProvider({ children }) {
  ...
  return /* @__PURE__ */ React49.createElement(TransactionStoreContext.Provider, {
    value: store
  }, children);
}
...
import React52, { useEffect as useEffect24, useMemo as useMemo20, useState as useState23 } from "react";
...
var SpinnerIcon = ({
  ...
  })), /* @__PURE__ */ React51.createElement("foreignObject", {
    clipPath: `url(#${id})`,
    height: "21",
    width: "21",
    x: "0",
...
var EmojiAvatar = ({ address, ensImage, size }) => {
  ...
  return ensImage ? loaded ? /* @__PURE__ */ React52.createElement(Box, {
...
import { useCallback as useCallback31, useEffect as useEffect25 } from "react";
...
import { useCallback as useCallback33, useEffect as useEffect27 } from "react";

// src/rainbowkit/src/components/AsyncImage/useAsyncImage.ts
import { useEffect as useEffect26, useReducer } from "react";
...
import React54, { useReducer as useReducer2 } from "react";
function AsyncImage({
  alt,
  background,
  borderColor,
  ...
  return /* @__PURE__ */ React54.createElement(Box, {
    ...
    width: "full"
  }), borderColor ? /* @__PURE__ */ React54.createElement(Box, {
...
var AssetsIcon = () => /* @__PURE__ */ React55.createElement(AsyncImage, {
  background: "#d0d5de",
  borderRadius: "10",
  height: "48",
  src,
...
var LoginIcon = () => /* @__PURE__ */ React56.createElement(AsyncImage, {
  background: "#d0d5de",
  borderRadius: "10",
  height: "48",
  src: src2,
...
import React59, { useCallback as useCallback32, useRef as useRef9 } from "react";
...
function ActionButton({
  ...
  return /* @__PURE__ */ React58.createElement(PixelCube2, {
    pixel_height: 2,
  ...
  }, /* @__PURE__ */ React58.createElement(Text2, {
...
function SignIn({ onClose }) {
  const [{ status, ...state }, setState] = React59.useState({ status: "idle" });
  const authAdapter = useAuthenticationAdapter();
  const getNonce = useCallback32(async () => {
    try {
  ...
  return /* @__PURE__ */ React59.createElement(Box, {
    ...
    position: "absolute",
    right: "0"
  }, /* @__PURE__ */ React59.createElement(DialogClose_default, {
    onClick: onClose
  })), /* @__PURE__ */ React59.createElement(Box, {
    alignItems: "center",
    display: "flex",
    ...
    src: signInIcon,
    width: 40
  }), /* @__PURE__ */ React59.createElement(Text2, {
    color: "modalText",
    size: mobile ? "20" : "18",
    textAlign: "center",
    weight: "heavy"
  }, "Verify your account")), /* @__PURE__ */ React59.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "column",
    gap: mobile ? "16" : "12"
    ...
    size: mobile ? "16" : "14",
    textAlign: "center"
  }, "To finish connecting, you must sign a message in your wallet to verify that you are the owner of this account."), status === "idle" && state.errorMessage ? /* @__PURE__ */ React59.createElement(Text2, {
    color: "error",
    size: mobile ? "16" : "14",
    textAlign: "center",
    weight: "bold"
  }, state.errorMessage) : null)), /* @__PURE__ */ React59.createElement(Box, {
    alignItems: !mobile ? "center" : void 0,
    display: "flex",
    flexDirection: "column",
    gap: "8",
    width: "full"
  }, /* @__PURE__ */ React59.createElement(ActionButton, {
  ...
  }), mobile ? /* @__PURE__ */ React59.createElement(ActionButton, {
    label: "Cancel",
    onClick: cancel,
    size: "large",
    type: "secondary"
...
function RainbowKitProvider({
  ...
  return /* @__PURE__ */ React60.createElement(RainbowKitChainProvider, {
    chains,
    initialChain
  }, /* @__PURE__ */ React60.createElement(CoolModeContext.Provider, {
    value: coolMode
  }, /* @__PURE__ */ React60.createElement(ModalSizeContext.Provider, {
    value: isSmallScreen ? ModalSizeOptions.COMPACT : modalSize
  }, /* @__PURE__ */ React60.createElement(ShowRecentTransactionsContext.Provider, {
    value: showRecentTransactions
  }, /* @__PURE__ */ React60.createElement(TransactionStoreProvider, null, /* @__PURE__ */ React60.createElement(AvatarContext.Provider, {
    value: avatarContext
  }, /* @__PURE__ */ React60.createElement(AppContext.Provider, {
    value: appContext
  }, /* @__PURE__ */ React60.createElement(ThemeIdContext.Provider, {
    value: id
  }, /* @__PURE__ */ React60.createElement(ModalProvider, null, theme ? /* @__PURE__ */ React60.createElement("div", {
    ...createThemeRootProps(id)
  }, /* @__PURE__ */ React60.createElement("style", {
...
import React61, { useCallback as useCallback34, useEffect as useEffect28, useRef as useRef10 } from "react";
...
function Dialog({ children, onClose, open, titleId }) {
  ...
  const handleBackdropClick = useCallback35(() => onClose(), [onClose]);
  const themeRootProps = useThemeRootProps();
  const mobile = isMobile();
  return /* @__PURE__ */ React62.createElement(React62.Fragment, null, open ? createPortal(
    /* @__PURE__ */ React62.createElement(RemoveScroll, {
      ...
      position: "fixed",
      role: "dialog"
    }, /* @__PURE__ */ React62.createElement(FocusTrap, {
      className: content,
...
import React63, { useContext as useContext6 } from "react";
...
function DialogContent4({
  ...
  return /* @__PURE__ */ React63.createElement(Box, {
    marginTop
  }, /* @__PURE__ */ React63.createElement(PixelBorderCard, {
    className: [
...
import React74, { useCallback as useCallback37, useContext as useContext9, useEffect as useEffect31, useState as useState26 } from "react";
...
function Avatar2({ address, imageUrl, loading, size }) {
  ...
  return /* @__PURE__ */ React64.createElement(Box, {
    ...
    userSelect: "none"
  }, /* @__PURE__ */ React64.createElement(AvatarComponent3, {
    address,
    ensImage: imageUrl,
    size
  })), typeof loading === "boolean" && /* @__PURE__ */ React64.createElement(Box, {
    color: "accentColor",
    display: "flex",
    height: "full",
    position: "absolute",
...
var CopiedIcon = () => /* @__PURE__ */ React65.createElement("svg", {
  fill: "none",
  height: "13",
  viewBox: "0 0 13 13",
  width: "13",
...
var CopyIcon = () => /* @__PURE__ */ React66.createElement("svg", {
  fill: "none",
  height: "16",
  viewBox: "0 0 17 16",
  width: "17",
...
var DisconnectIcon = () => /* @__PURE__ */ React67.createElement("svg", {
  fill: "none",
  height: "16",
  viewBox: "0 0 18 16",
  width: "18",
...
import React72, { useContext as useContext8 } from "react";
...
var ExternalLinkIcon = () => /* @__PURE__ */ React68.createElement("svg", {
  fill: "none",
  height: "19",
  viewBox: "0 0 20 19",
  width: "20",
...
var CancelIcon = () => /* @__PURE__ */ React69.createElement("svg", {
  fill: "none",
  height: "19",
  viewBox: "0 0 20 19",
  width: "20",
...
var SuccessIcon = () => /* @__PURE__ */ React70.createElement("svg", {
  fill: "none",
  height: "20",
  viewBox: "0 0 20 20",
  width: "20",
...
function TxItem({ tx }) {
  ...
  return /* @__PURE__ */ React71.createElement(React71.Fragment, null, /* @__PURE__ */ React71.createElement(Box, {
    ...explorerLink ? {
      as: "a",
    ...
    color
  }, /* @__PURE__ */ React71.createElement(Icon2, null)), /* @__PURE__ */ React71.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: mobile ? "3" : "1"
  }, /* @__PURE__ */ React71.createElement(Box, null, /* @__PURE__ */ React71.createElement(Text2, {
    color: "modalText",
    font: "body",
    size: mobile ? "16" : "14",
    weight: "bold"
  }, tx == null ? void 0 : tx.description)), /* @__PURE__ */ React71.createElement(Box, null, /* @__PURE__ */ React71.createElement(Text2, {
    color: tx.status === "pending" ? "modalTextSecondary" : color,
    font: "body",
    size: "14",
    weight: mobile ? "medium" : "regular"
  }, confirmationStatus)))), explorerLink && /* @__PURE__ */ React71.createElement(Box, {
    alignItems: "center",
    color: "modalTextDim",
    display: "flex"
  }, /* @__PURE__ */ React71.createElement(ExternalLinkIcon, null))));
}
...
function TxList({ address }) {
  ...
  return /* @__PURE__ */ React72.createElement(React72.Fragment, null, /* @__PURE__ */ React72.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "10",
    paddingBottom: "2",
  ...
  }, hasTransactions && /* @__PURE__ */ React72.createElement(Box, {
    ...
    display: "flex",
    justifyContent: "space-between"
  }, /* @__PURE__ */ React72.createElement(Text2, {
    color: "modalTextSecondary",
    size: mobile ? "16" : "14",
    weight: "semibold"
  }, "Recent Transactions"), /* @__PURE__ */ React72.createElement(Box, {
    style: {
      marginBottom: -6,
      marginLeft: -10,
      marginRight: -10,
    ...
    size: mobile ? "16" : "14",
    weight: "semibold"
  }, "Clear All"))))), /* @__PURE__ */ React72.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, hasTransactions ? visibleTxs.map((tx) => /* @__PURE__ */ React72.createElement(TxItem, {
    key: tx.hash,
    tx
  })) : /* @__PURE__ */ React72.createElement(React72.Fragment, null, /* @__PURE__ */ React72.createElement(Box, {
    padding: mobile ? "12" : "8"
  }, /* @__PURE__ */ React72.createElement(Text2, {
    color: "modalTextDim",
    size: mobile ? "16" : "14",
    weight: mobile ? "medium" : "bold"
  }, appName != null ? appName : "Your", " transactions will appear here...")), mobile && /* @__PURE__ */ React72.createElement(Box, {
    background: "generalBorderDim",
    height: "1",
    marginX: "12",
    marginY: "8"
  })))), explorerLink && /* @__PURE__ */ React72.createElement(Box, {
    paddingBottom: "18",
    paddingX: mobile ? "8" : "18"
  }, /* @__PURE__ */ React72.createElement(Box, {
    alignItems: "center",
  ...
  }, "View more on Explorer"), /* @__PURE__ */ React72.createElement(ExternalLinkIcon, null))));
}
...
function ProfileDetailsAction({
  ...
  return /* @__PURE__ */ React73.createElement(Box, {
    ...
    color: "modalText",
    height: "max"
  }, icon), /* @__PURE__ */ React73.createElement(Box, null, /* @__PURE__ */ React73.createElement(Text2, {
    color: "modalText",
    size: mobile ? "12" : "13",
    weight: "semibold"
  }, label))));
...
function ProfileDetails({
  ...
  const copyAddressAction = useCallback37(() => {
    if (address) {
  ...
  return /* @__PURE__ */ React74.createElement(React74.Fragment, null, /* @__PURE__ */ React74.createElement(Box, {
    display: "flex",
    flexDirection: "column"
  ...
  }, /* @__PURE__ */ React74.createElement(DialogClose_default, {
    onClick: onClose
  })), /* @__PURE__ */ React74.createElement(Box, {
    marginTop: mobile ? "24" : "0"
  }, /* @__PURE__ */ React74.createElement(Avatar2, {
    address,
    imageUrl: ensAvatar,
    size: mobile ? 82 : 74
  })), /* @__PURE__ */ React74.createElement(Box, {
    ...
    textAlign: "center"
  }, /* @__PURE__ */ React74.createElement(Text2, {
    as: "h1",
    color: "modalText",
    id: titleId,
    size: mobile ? "20" : "18",
    weight: "heavy"
  }, accountName)), balanceData && /* @__PURE__ */ React74.createElement(Box, {
    textAlign: "center"
  }, /* @__PURE__ */ React74.createElement(Text2, {
    as: "h1",
    color: "modalTextSecondary",
    ...
    size: mobile ? "16" : "14",
    weight: "semibold"
  }, displayBalance, " ", balanceData.symbol)))), /* @__PURE__ */ React74.createElement(Box, {
    display: "flex",
    flexDirection: "row",
    gap: "8",
    margin: "2",
    marginTop: "16"
  }, /* @__PURE__ */ React74.createElement(ProfileDetailsAction, {
    action: copyAddressAction,
    icon: copiedAddress ? /* @__PURE__ */ React74.createElement(CopiedIcon, null) : /* @__PURE__ */ React74.createElement(CopyIcon, null),
    label: copiedAddress ? "Copied!" : "Copy Address"
  }), /* @__PURE__ */ React74.createElement(ProfileDetailsAction, {
    action: onDisconnect,
    icon: /* @__PURE__ */ React74.createElement(DisconnectIcon, null),
    label: "Disconnect",
    testId: "disconnect-button"
  }))), showRecentTransactions && /* @__PURE__ */ React74.createElement(React74.Fragment, null, /* @__PURE__ */ React74.createElement(Box, {
    background: "generalBorder",
    height: "1",
    marginTop: "-1"
  }), /* @__PURE__ */ React74.createElement(Box, null, /* @__PURE__ */ React74.createElement(TxList, {
    address
  })))));
}
...
function AccountModal({ onClose, open }) {
  ...
  return /* @__PURE__ */ React75.createElement(React75.Fragment, null, address && /* @__PURE__ */ React75.createElement(Dialog, {
    onClose,
    open,
    titleId
  }, /* @__PURE__ */ React75.createElement(DialogContent4, {
    bottomSheetOnMobile: true,
    padding: "0"
  }, /* @__PURE__ */ React75.createElement(ProfileDetails, {
    address,
    balanceData,
    ensAvatar,
    ensName,
...
import React78, { Fragment, useCallback as useCallback38, useContext as useContext10 } from "react";
...
var DisconnectSqIcon = ({ size }) => /* @__PURE__ */ React76.createElement("svg", {
  fill: "none",
  height: size,
  viewBox: "0 0 28 28",
  width: size,
...
// src/rainbowkit/src/components/MenuButton/MenuButton.tsx
var MenuButton = React77.forwardRef(
  ({
    children,
    ...
    return /* @__PURE__ */ React77.createElement(Box, {
      ...
      marginBottom: "8",
      onClick
    }, /* @__PURE__ */ React77.createElement(PixelCube3, {
      pixel_height: 3,
...
function ChainModal({ onClose, open, fn }) {
  ...
  const rainbowkitChains = useRainbowKitChains();
  const chainClickHandle = useCallback38(
  ...
  return /* @__PURE__ */ React78.createElement(Dialog, {
    onClose,
    open,
    titleId
  }, /* @__PURE__ */ React78.createElement(DialogContent4, {
    padding: "0",
    bottomSheetOnMobile: true
    ...
    gap: isW768 ? "0" : "14",
    marginBottom: "14"
  }, /* @__PURE__ */ React78.createElement(ActivePixelCard, {
    pixel_height: 10,
    ...
    flexDirection: "row",
    justifyContent: "space-between"
  }, mobile && /* @__PURE__ */ React78.createElement(Box, {
    width: "30"
  }), /* @__PURE__ */ React78.createElement(Text2, {
    as: "h3",
    color: "modalText",
    weight: "bold",
    id: titleId,
  ...
  }, "Switch Networks"))), unsupportedChain && /* @__PURE__ */ React78.createElement(Box, {
    marginLeft: "20",
    marginRight: "20",
    ...
    size: "14",
    weight: "medium"
  }, "Wrong network detected, switch or disconnect to continue.")), /* @__PURE__ */ React78.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4",
    padding: "2",
    ...
    return /* @__PURE__ */ React78.createElement(Fragment, {
      key: chain.id
    }, /* @__PURE__ */ React78.createElement(MenuButton, {
      disabled: false,
      ...
      size: "14",
      weight: "medium"
    }, "Connected"), /* @__PURE__ */ React78.createElement(Box, {
      ...
      marginLeft: "8",
      width: "12"
    })), switching && /* @__PURE__ */ React78.createElement(Box, {
      alignItems: "center",
      display: "flex",
      flexDirection: "row",
      marginRight: "6"
      ...
      borderStyle: "solid",
      borderWidth: "3"
    }))))), mobile && idx < rainbowkitChains.length - 1 && /* @__PURE__ */ React78.createElement(Box, {
      background: "generalBorderDim",
      height: "1",
      marginX: "8"
    }));
    ...
    size: "14",
    weight: "medium"
  }, "Your wallet does not support switching networks from", " ", appName != null ? appName : "this app", ". Try switching networks from within your wallet instead.")), unsupportedChain && /* @__PURE__ */ React78.createElement(React78.Fragment, null, /* @__PURE__ */ React78.createElement(Box, {
    background: "generalBorderDim",
    height: "1",
    marginX: "8"
  }), /* @__PURE__ */ React78.createElement(MenuButton, {
    ...
    justifyContent: "center",
    marginRight: "8"
  }, /* @__PURE__ */ React78.createElement(DisconnectSqIcon, {
    size: Number(chainIconSize)
  })), /* @__PURE__ */ React78.createElement("div", null, "Disconnect")))))))), /* @__PURE__ */ React78.createElement(DialogClose_default, {
    onClick: onClose
  })));
}
...
import React91, { Fragment as Fragment2, useContext as useContext14, useEffect as useEffect34, useState as useState28 } from "react";
...
var DisclaimerText = ({ children }) => {
  return /* @__PURE__ */ React80.createElement(Text2, {
    color: "modalTextSecondary",
    size: "12",
    weight: "medium"
  }, children);
...
function ConnectModalIntro({
  ...
  return /* @__PURE__ */ React81.createElement(React81.Fragment, null, /* @__PURE__ */ React81.createElement(Box, {
    alignItems: "center",
    color: "accentColor",
    display: "flex",
    flexDirection: "column",
    ...
    marginBottom: "10"
  }, !compactModeEnabled && /* @__PURE__ */ React81.createElement(Text2, {
    color: "modalText",
    size: "18",
    weight: "heavy"
  }, "What is a Wallet?")), /* @__PURE__ */ React81.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "32",
    justifyContent: "center",
    ...
    minWidth: "48",
    width: "48"
  }, /* @__PURE__ */ React81.createElement(AssetsIcon, null)), /* @__PURE__ */ React81.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, /* @__PURE__ */ React81.createElement(Text2, {
    color: "modalText",
    size: "14",
    weight: "bold"
  }, "A Home for your Digital Assets"), /* @__PURE__ */ React81.createElement(Text2, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, "Wallets are used to send, receive, store, and display digital assets like Ethereum and NFTs."))), /* @__PURE__ */ React81.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "row",
    gap: "16"
    ...
    minWidth: "48",
    width: "48"
  }, /* @__PURE__ */ React81.createElement(LoginIcon, null)), /* @__PURE__ */ React81.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, /* @__PURE__ */ React81.createElement(Text2, {
    ...
    size: "14",
    weight: "bold"
  }, "A New Way to Log In"), /* @__PURE__ */ React81.createElement(Text2, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, "Instead of creating new accounts and passwords on every website, just connect your wallet.")))), /* @__PURE__ */ React81.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "column",
    gap: "12",
    justifyContent: "center",
    margin: "10"
  }, /* @__PURE__ */ React81.createElement(ActionButton, {
    label: "Get a Wallet",
    onClick: getWallet
  }), /* @__PURE__ */ React81.createElement(Box, {
    as: "a",
    ...
    size: "14",
    weight: "bold"
  }, "Learn More"))), Disclaimer && !compactModeEnabled && /* @__PURE__ */ React81.createElement(Box, {
    marginBottom: "8",
    marginTop: "12",
    textAlign: "center"
  }, /* @__PURE__ */ React81.createElement(Disclaimer, {
    Link: DisclaimerLink,
    Text: DisclaimerText
  }))));
}
...
var BackIcon = () => /* @__PURE__ */ React82.createElement("svg", {
  fill: "none",
  height: "17",
  viewBox: "0 0 11 17",
  width: "11",
...
var InfoIcon = () => /* @__PURE__ */ React83.createElement("svg", {
  fill: "none",
  height: "12",
  viewBox: "0 0 8 12",
  width: "8",
...
var InfoButton = ({
  ...
  return /* @__PURE__ */ React84.createElement(Box, {
    ...
    type: "button",
    width: mobile ? "30" : "28"
  }, /* @__PURE__ */ React84.createElement(InfoIcon, null));
};
...
import { useContext as useContext12, useEffect as useEffect32, useRef as useRef11 } from "react";
...
var ModalSelection = ({
  ...
  return /* @__PURE__ */ React85.createElement(Box, {
    ...
    ref: coolModeRef
  }, /* @__PURE__ */ React85.createElement(ActivePixelCard, {
    pixel_height: 4,
    ...currentlySelected ? {
      backgroundColor: "#1649FF"
    } : {
    ...
    gap: "12",
    width: "max"
  }, /* @__PURE__ */ React85.createElement(AsyncImage, {
    background: iconBackground,
    ...
    src: iconUrl,
    width: "28"
  }), /* @__PURE__ */ React85.createElement(Box, null, /* @__PURE__ */ React85.createElement(Box, {
    style: { marginTop: recent ? -2 : void 0 }
  }, name), recent && /* @__PURE__ */ React85.createElement(Text2, {
...
import React90, { useContext as useContext13, useEffect as useEffect33 } from "react";
...
var CreateIcon = () => /* @__PURE__ */ React86.createElement(AsyncImage, {
  background: "#e3a5e8",
...
var RefreshIcon = () => /* @__PURE__ */ React87.createElement(AsyncImage, {
  background: "#515a70",
  borderColor: "generalBorder",
  borderRadius: "10",
  height: "48",
...
var ScanIcon = () => /* @__PURE__ */ React88.createElement(AsyncImage, {
  background: "#515a70",
  borderColor: "generalBorder",
  borderRadius: "10",
  height: "48",
...
function QRCode({
  ...
  return /* @__PURE__ */ React89.createElement(Box, {
    ...
    width: "full"
  }, /* @__PURE__ */ React89.createElement(AsyncImage, {
    ...
    src: logoUrl,
    width: logoSize
  })), /* @__PURE__ */ React89.createElement("svg", {
    height: size,
    style: { all: "revert" },
    width: size
  ...
  })), /* @__PURE__ */ React89.createElement("clipPath", {
    id: "clip-logo"
  }, /* @__PURE__ */ React89.createElement("rect", {
    height: logoSize,
    width: logoSize
...
function GetDetail({
  ...
  return /* @__PURE__ */ React90.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "column",
    height: "full",
    marginTop: "18",
    width: "full"
  }, /* @__PURE__ */ React90.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "column",
    gap: "28",
    ...
    return /* @__PURE__ */ React90.createElement(Box, {
      ...
      flexDirection: "row",
      gap: "16"
    }, /* @__PURE__ */ React90.createElement(AsyncImage, {
      background: iconBackground,
      borderColor: "actionButtonBorder",
      borderRadius: "10",
      height: "48",
      ...
      flexDirection: "column",
      gap: "2"
    }, /* @__PURE__ */ React90.createElement(Text2, {
      color: "modalText",
      size: "14",
      weight: "bold"
    }, name), /* @__PURE__ */ React90.createElement(Text2, {
      color: "modalTextSecondary",
      size: "14",
      weight: "medium"
    }, hasMobileAndExtension ? "Mobile Wallet and Extension" : hasMobileCompanionApp ? "Mobile Wallet" : hasExtension ? "Browser Extension" : null))), /* @__PURE__ */ React90.createElement(Box, {
      display: "flex",
      flexDirection: "column",
      gap: "4"
    }, /* @__PURE__ */ React90.createElement(ActionButton, {
      label: "GET",
    ...
    size: "14",
    weight: "bold"
  }, "Not what you\u2019re looking for?"), /* @__PURE__ */ React90.createElement(Text2, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
...
function ConnectDetail({
  ...
  return /* @__PURE__ */ React90.createElement(Box, {
    ...
    height: "full",
    width: "full"
  }, hasQrCode ? /* @__PURE__ */ React90.createElement(Box, {
    alignItems: "center",
    display: "flex",
    height: "full",
    justifyContent: "center"
  }, /* @__PURE__ */ React90.createElement(QRCode, {
    ...
    size: "18",
    weight: "bold"
  }, ready ? `Opening ${name}...` : hasExtension ? `${name} is not installed` : `${name} is not available`), !ready && hasExtension ? /* @__PURE__ */ React90.createElement(Box, {
    paddingTop: "20"
  }, /* @__PURE__ */ React90.createElement(ActionButton, {
    href: wallet.extensionDownloadUrl,
    label: "INSTALL",
    type: "secondary"
  })) : null, ready && !hasQrCode && /* @__PURE__ */ React90.createElement(React90.Fragment, null, /* @__PURE__ */ React90.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "column",
    justifyContent: "center"
    ...
    textAlign: "center",
    weight: "medium"
  }, "Confirm connection in the extension")), /* @__PURE__ */ React90.createElement(Box, {
    alignItems: "center",
    color: "modalText",
    display: "flex",
    flexDirection: "row",
    height: "32",
    marginTop: "8"
  }, connectionError ? /* @__PURE__ */ React90.createElement(ActionButton, {
    label: "RETRY",
    ...
    color: "modalTextSecondary"
  }, /* @__PURE__ */ React90.createElement(SpinnerIcon, null))))))), /* @__PURE__ */ React90.createElement(Box, {
    alignItems: "center",
    borderRadius: "10",
    display: "flex",
    flexDirection: "row",
    ...
    justifyContent: "space-between",
    marginTop: "12"
  }, ready && secondaryAction && /* @__PURE__ */ React90.createElement(React90.Fragment, null, /* @__PURE__ */ React90.createElement(Text2, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, secondaryAction.description), /* @__PURE__ */ React90.createElement(ActionButton, {
...
var DownloadOptionsBox = ({
  ...
  return /* @__PURE__ */ React90.createElement(Box, {
  ...
  }), isBrowserCard && /* @__PURE__ */ React90.createElement(Box, {
    ...
    src: iconUrl,
    width: "200"
  })))), !isBrowserCard && gradientRgbas && /* @__PURE__ */ React90.createElement(Box, {
    ...
    justifyContent: "center",
    style: { zIndex: 1 }
  }, /* @__PURE__ */ React90.createElement(Box, null, /* @__PURE__ */ React90.createElement(AsyncImage, {
    height: "60",
    src: iconUrl,
    width: "60",
    ...iconBackground ? {
    ...
    size: "14",
    weight: "bold"
  }, title), /* @__PURE__ */ React90.createElement(Text2, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, description), /* @__PURE__ */ React90.createElement(Box, {
    marginTop: "14",
    width: "max"
  }, /* @__PURE__ */ React90.createElement(ActionButton, {
    href: url,
...
function DownloadOptionsDetail({
  ...
  return /* @__PURE__ */ React90.createElement(Box, {
    ...
    justifyContent: "center",
    width: "full"
  }, extensionDownloadUrl && /* @__PURE__ */ React90.createElement(DownloadOptionsBox, {
    ...
    variant: "browser"
  }), mobileDownloadUrl && /* @__PURE__ */ React90.createElement(DownloadOptionsBox, {
...
function DownloadDetail({
  ...
  return /* @__PURE__ */ React90.createElement(Box, {
    ...
    size: "14",
    weight: "semibold"
  }, "Scan with your phone to download on iOS or Android")), /* @__PURE__ */ React90.createElement(Box, {
    height: "full"
  }, (downloadUrls == null ? void 0 : downloadUrls.qrCode) ? /* @__PURE__ */ React90.createElement(QRCode, {
    logoSize: 0,
    size: 268,
    uri: downloadUrls.qrCode
  }) : null), /* @__PURE__ */ React90.createElement(Box, {
    alignItems: "center",
    borderRadius: "10",
    display: "flex",
    flexDirection: "row",
...
var stepIcons = {
  create: () => /* @__PURE__ */ React90.createElement(CreateIcon, null),
  install: (wallet) => /* @__PURE__ */ React90.createElement(AsyncImage, {
  ...
  refresh: () => /* @__PURE__ */ React90.createElement(RefreshIcon, null),
  scan: () => /* @__PURE__ */ React90.createElement(ScanIcon, null)
};
function InstructionMobileDetail({
  ...
  return /* @__PURE__ */ React90.createElement(Box, {
    ...
    return /* @__PURE__ */ React90.createElement(Box, {
      ...
      position: "relative",
      width: "48"
    }, (_a2 = stepIcons[d.step]) == null ? void 0 : _a2.call(stepIcons, wallet)), /* @__PURE__ */ React90.createElement(Box, {
      display: "flex",
      flexDirection: "column",
      gap: "4"
    }, /* @__PURE__ */ React90.createElement(Text2, {
      ...
      size: "14",
      weight: "bold"
    }, d.title), /* @__PURE__ */ React90.createElement(Text2, {
      color: "modalTextSecondary",
      size: "14",
      weight: "medium"
    }, d.description)));
...
function DesktopOptions({ onClose }) {
  ...
  switch (walletStep) {
    case "NONE" /* None */:
      walletContent = /* @__PURE__ */ React91.createElement(ConnectModalIntro, {
    ...
    case "LEARN_COMPACT" /* LearnCompact */:
      ...
      break;
    case "GET" /* Get */:
      walletContent = /* @__PURE__ */ React91.createElement(GetDetail, {
        getWalletDownload
      });
    ...
    case "CONNECT" /* Connect */:
      walletContent = selectedWallet && /* @__PURE__ */ React91.createElement(ConnectDetail, {
        changeWalletStep,
        compactModeEnabled,
        connectionError,
        onClose,
    ...
    case "DOWNLOAD_OPTIONS" /* DownloadOptions */:
      walletContent = selectedWallet && /* @__PURE__ */ React91.createElement(DownloadOptionsDetail, {
        changeWalletStep,
        wallet: selectedWallet
      });
    ...
    case "DOWNLOAD" /* Download */:
      walletContent = selectedWallet && /* @__PURE__ */ React91.createElement(DownloadDetail, {
        changeWalletStep,
        wallet: selectedWallet
      });
    ...
    case "INSTRUCTIONS_MOBILE" /* InstructionsMobile */:
      walletContent = selectedWallet && /* @__PURE__ */ React91.createElement(InstructionMobileDetail, {
    ...
    case "INSTRUCTIONS_EXTENSION" /* InstructionsExtension */:
      walletContent = selectedWallet && /* @__PURE__ */ React91.createElement(InstructionExtensionDetail, {
        wallet: selectedWallet
      });
      headerLabel = selectedWallet && `Get started with ${compactModeEnabled ? selectedWallet.shortName || selectedWallet.name : selectedWallet.name}`;
  ...
  return /* @__PURE__ */ React91.createElement(Box, {
  ...
  }, (compactModeEnabled ? walletStep === "NONE" /* None */ : true) && /* @__PURE__ */ React91.createElement(Box, {
    ...
    display: "flex",
    justifyContent: "space-between"
  }, compactModeEnabled && Disclaimer && /* @__PURE__ */ React91.createElement(Box, {
    marginLeft: "16",
    width: "28"
  }, /* @__PURE__ */ React91.createElement(InfoButton, {
    ...
    paddingTop: "2",
    paddingX: "18"
  }, /* @__PURE__ */ React91.createElement(Text2, {
    as: "h1",
    color: "modalText",
    id: titleId,
    size: "18",
    weight: "heavy"
  }, "Connect a Wallet")), compactModeEnabled && /* @__PURE__ */ React91.createElement(Box, {
    marginRight: "16"
  }, /* @__PURE__ */ React91.createElement(DialogClose_default, {
    onClick: onClose
  }))), /* @__PURE__ */ React91.createElement(Box, {
    className: ScrollClassName,
    paddingBottom: "18"
  }, Object.entries(groupedWallets).map(
    ([groupName, wallets2], index) => wallets2.length > 0 && /* @__PURE__ */ React91.createElement(Fragment2, {
      key: index
    }, groupName ? /* @__PURE__ */ React91.createElement(Box, {
      marginBottom: "8",
      marginTop: "16",
      marginX: "6"
    }, /* @__PURE__ */ React91.createElement(Text2, {
      ...
      size: "14",
      weight: "bold"
    }, groupName)) : null, /* @__PURE__ */ React91.createElement(Box, {
      display: "flex",
      flexDirection: "column",
      gap: "4"
    }, wallets2.map((wallet) => {
      return /* @__PURE__ */ React91.createElement(ModalSelection, {
  ...
  )), compactModeEnabled && /* @__PURE__ */ React91.createElement(React91.Fragment, null, /* @__PURE__ */ React91.createElement(Box, {
    background: "generalBorder",
    height: "1",
    marginTop: "-1"
  }), Disclaimer ? /* @__PURE__ */ React91.createElement(Box, {
    paddingX: "24",
    paddingY: "16",
    textAlign: "center"
  }, /* @__PURE__ */ React91.createElement(Disclaimer, {
    Link: DisclaimerLink,
    Text: DisclaimerText
  })) : /* @__PURE__ */ React91.createElement(Box, {
    alignItems: "center",
    ...
    size: "14",
    weight: "medium"
  }, "New to Ethereum wallets?")), /* @__PURE__ */ React91.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "row",
    gap: "4",
    ...
    size: "14",
    weight: "bold"
  }, "Learn More")))))), (compactModeEnabled ? walletStep !== "NONE" /* None */ : true) && /* @__PURE__ */ React91.createElement(React91.Fragment, null, !compactModeEnabled && /* @__PURE__ */ React91.createElement(Box, {
    background: "generalBorder",
    minWidth: "1",
    width: "1"
  }), /* @__PURE__ */ React91.createElement(Box, {
    ...
    width: "28"
  }, headerBackButtonLink && /* @__PURE__ */ React91.createElement(Box, {
    as: "button",
    className: touchableStyles({
      active: "shrinkSm",
      hover: "growLg"
    ...
    transition: "default",
    type: "button"
  }, /* @__PURE__ */ React91.createElement(BackIcon, null))), /* @__PURE__ */ React91.createElement(Box, {
    display: "flex",
    justifyContent: "center",
    style: { flexGrow: 1 }
  }, headerLabel && /* @__PURE__ */ React91.createElement(Text2, {
    color: "modalText",
    size: "18",
    textAlign: "center",
    weight: "heavy"
  }, headerLabel)), /* @__PURE__ */ React91.createElement(DialogClose_default, {
    onClick: onClose
  })), /* @__PURE__ */ React91.createElement(Box, {
    display: "flex",
    flexDirection: "column",
...
import React92, { useCallback as useCallback39, useContext as useContext15, useState as useState29 } from "react";
...
function WalletButton({
  ...
  const coolModeRef = useCoolMode(iconUrl);
  return /* @__PURE__ */ React92.createElement(Box, {
    as: "button",
    color: ready ? "modalText" : "modalTextSecondary",
    disabled: !ready,
    fontFamily: "body",
    key: id,
    onClick: useCallback39(async () => {
      if (id === "walletConnect")
    ...
    paddingBottom: "8",
    paddingTop: "10"
  }, /* @__PURE__ */ React92.createElement(AsyncImage, {
    background: iconBackground,
    borderRadius: "13",
    ...
    flexDirection: "column",
    textAlign: "center"
  }, /* @__PURE__ */ React92.createElement(Text2, {
    as: "h2",
    ...
    as: "span",
    position: "relative"
  }, shortName != null ? shortName : name, !wallet.ready && " (unsupported)")), wallet.recent && /* @__PURE__ */ React92.createElement(Text2, {
    color: "accentColor",
    size: "12",
    weight: "medium"
  }, "Recent"))));
...
function MobileOptions({ onClose }) {
  ...
  switch (walletStep) {
    case "CONNECT" /* Connect */: {
      ...
      walletContent = /* @__PURE__ */ React92.createElement(Box, null, /* @__PURE__ */ React92.createElement(Box, {
        background: "profileForeground",
        className: scroll,
        display: "flex",
        paddingBottom: "20",
        ...
        return /* @__PURE__ */ React92.createElement(Box, {
          ...
          width: "60"
        }, /* @__PURE__ */ React92.createElement(WalletButton, {
          onClose,
          wallet
        })));
      }))), /* @__PURE__ */ React92.createElement(Box, {
        ...
        size: "16",
        weight: "bold"
      }, "What is a Wallet?"), /* @__PURE__ */ React92.createElement(Text2, {
        color: "modalTextSecondary",
        size: "16"
      }, "A wallet is used to send, receive, store, and display digital assets. It\u2019s also a new way to log in, without needing to create new accounts and passwords on\xA0every\xA0website."))), /* @__PURE__ */ React92.createElement(Box, {
        paddingTop: "32",
        paddingX: "20"
      }, /* @__PURE__ */ React92.createElement(Box, {
        display: "flex",
        gap: "14",
        justifyContent: "center"
      }, /* @__PURE__ */ React92.createElement(ActionButton, {
        label: "Get a Wallet",
        ...
        size: "large",
        type: "secondary"
      }))), Disclaimer && /* @__PURE__ */ React92.createElement(Box, {
        marginTop: "28",
        marginX: "32",
        textAlign: "center"
      }, /* @__PURE__ */ React92.createElement(Disclaimer, {
        Link: DisclaimerLink,
        Text: DisclaimerText
      })));
      break;
    ...
    case "GET" /* Get */: {
      ...
      walletContent = /* @__PURE__ */ React92.createElement(Box, null, /* @__PURE__ */ React92.createElement(Box, {
        ...
        return /* @__PURE__ */ React92.createElement(Box, {
          ...
          size: "18",
          weight: "bold"
        }, name)), /* @__PURE__ */ React92.createElement(ActionButton, {
          ...
          size: "small",
          type: "secondary"
        })), index < mobileWallets.length - 1 && /* @__PURE__ */ React92.createElement(Box, {
          background: "generalBorderDim",
          height: "1",
          marginY: "10",
          width: "full"
        ...
        size: "16",
        weight: "bold"
      }, "Not what you\u2019re looking for?"), /* @__PURE__ */ React92.createElement(Text2, {
        color: "modalTextSecondary",
        size: "16"
  ...
  return /* @__PURE__ */ React92.createElement(Box, {
    ...
    paddingX: "20",
    position: "relative"
  }, headerBackButtonLink && /* @__PURE__ */ React92.createElement(Box, {
    display: "flex",
    position: "absolute",
    style: {
      left: 0,
    ...
    transition: "default",
    type: "button"
  }, /* @__PURE__ */ React92.createElement(BackIcon, null))), /* @__PURE__ */ React92.createElement(Box, {
    marginTop: "4",
    textAlign: "center",
    width: "full"
  }, /* @__PURE__ */ React92.createElement(Text2, {
    ...
    size: "20",
    weight: "bold"
  }, headerLabel)), /* @__PURE__ */ React92.createElement(Box, {
    alignItems: "center",
    display: "flex",
    height: "32",
    paddingRight: "14",
  ...
  }, /* @__PURE__ */ React92.createElement(DialogClose_default, {
    onClick: onClose,
    style: { top: "6px" }
  }))))), /* @__PURE__ */ React92.createElement(Box, {
    display: "flex",
...
function ConnectOptions({ onClose }) {
  return isMobile() ? /* @__PURE__ */ React93.createElement(MobileOptions, {
    onClose
  }) : /* @__PURE__ */ React93.createElement(DesktopOptions, {
    onClose
  });
}
...
function ConnectModal({ onClose, open }) {
  ...
  if (connectionStatus === "disconnected") {
    return /* @__PURE__ */ React94.createElement(Dialog, {
      onClose,
      open,
      titleId
    }, /* @__PURE__ */ React94.createElement(DialogContent4, {
      bottomSheetOnMobile: true,
      padding: "0",
      wide: true
    }, /* @__PURE__ */ React94.createElement(ConnectOptions, {
      onClose
    })));
  }
  if (connectionStatus === "unauthenticated") {
    return /* @__PURE__ */ React94.createElement(Dialog, {
      ...
      bottomSheetOnMobile: true,
      padding: "0"
    }, /* @__PURE__ */ React94.createElement(SignIn, {
      onClose
    })));
  }
  return null;
...
function useModalStateValue() {
  ...
  return {
    closeModal: useCallback40(() => {
      setWalletDialogOpen(false);
      setModalOpen(false);
    }, []),
    isModalOpen,
    openModal: useCallback40(() => setModalOpen(true), [])
  };
}
...
function ModalProvider({ children }) {
  ...
  }, children, /* @__PURE__ */ React95.createElement(ConnectModal, {
    onClose: closeConnectModal,
    open: connectModalOpen
  }), /* @__PURE__ */ React95.createElement(AccountModal, {
    onClose: closeAccountModal,
    open: accountModalOpen
  }), /* @__PURE__ */ React95.createElement(ChainModal, {
...
// src/components/Header/rainbow_account/WrongNetwork.tsx
var WrongNetwork = memo39(() => {
  const { t } = useCustomTranslation([LngNs.common]);
  const { openChainModal } = useChainModal();
  const setAccountInfoDialogOpen = useSetRecoilState16(accountInfoDialogState);
  return /* @__PURE__ */ React96.createElement(IsPixelWidget_default, {
    onClick: () => {
      if (openChainModal) {
        openChainModal();
        setAccountInfoDialogOpen(false);
  ...
  }, /* @__PURE__ */ React96.createElement("p", null, t("Wrong network")));
}, isEqual);
...
var DropdownIcon = () => /* @__PURE__ */ React97.createElement("svg", {
  fill: "none",
  height: "7",
  width: "14",
  xmlns: "http://www.w3.org/2000/svg"
...
import React98, { useContext as useContext17 } from "react";
...
import { useEffect as useEffect35, useReducer as useReducer3 } from "react";
var useIsMounted = () => {
  const [mounted, setMounted] = useReducer3(() => true, false);
  useEffect35(setMounted, [setMounted]);
  return mounted;
};
...
function ConnectButton({
  ...
  const connectionStatus = useConnectionStatus();
  return /* @__PURE__ */ React99.createElement(ConnectButtonRenderer, null, ({ account, chain, mounted, openAccountModal, openChainModal, openConnectModal }) => {
    var _a, _b, _c;
    const ready = mounted && connectionStatus !== "loading";
    const unsupportedChain = (_a = chain == null ? void 0 : chain.unsupported) != null ? _a : false;
    return /* @__PURE__ */ React99.createElement(Box, {
      display: "flex",
      gap: "12",
      ...!ready && {
        "aria-hidden": true,
    ...
    }, ready && account && connectionStatus === "connected" ? /* @__PURE__ */ React99.createElement(React99.Fragment, null, chain && (chains.length > 1 || unsupportedChain) && /* @__PURE__ */ React99.createElement(Box, {
      alignItems: "center",
      ...
      transition: "default",
      type: "button"
    }, unsupportedChain ? /* @__PURE__ */ React99.createElement(Box, {
      alignItems: "center",
      display: "flex",
      height: "24",
      paddingX: "4"
    }, "Wrong network") : /* @__PURE__ */ React99.createElement(Box, {
      alignItems: "center",
      display: "flex",
      gap: "6"
    }, chain.hasIcon ? /* @__PURE__ */ React99.createElement(Box, {
      display: mapResponsiveValue(chainStatus, (value) => value === "full" || value === "icon" ? "block" : "none"),
      height: "24",
      width: "24"
    }, /* @__PURE__ */ React99.createElement(AsyncImage, {
      ...
      src: chain.iconUrl,
      width: "24"
    })) : null, /* @__PURE__ */ React99.createElement(Box, {
    ...
    }, (_c = chain.name) != null ? _c : chain.id)), /* @__PURE__ */ React99.createElement(DropdownIcon, null)), !unsupportedChain && /* @__PURE__ */ React99.createElement(Box, {
      alignItems: "center",
      as: "button",
      ...
      transition: "default",
      type: "button"
    }, account.displayBalance && /* @__PURE__ */ React99.createElement(Box, {
    ...
    }, /* @__PURE__ */ React99.createElement(Avatar2, {
    ...
    }, account.displayName), /* @__PURE__ */ React99.createElement(DropdownIcon, null)))))) : /* @__PURE__ */ React99.createElement(Box, {
      as: "button",
...
// src/components/Header/rainbow_account/rainbow_connectWallet.tsx
var RainbowConnectWallet = memo40((props) => {
  const { t } = useCustomTranslation([LngNs.common]);
  const {
    isBigWidth,
    isMiddleWidth,
  ...
  return /* @__PURE__ */ React100.createElement("div", {
    className: `connect_pixel_connectWallet
        ${className != null ? className : ""}`
  }, /* @__PURE__ */ React100.createElement(ConnectButton.Custom, null, ({ chain, openConnectModal, mounted }) => {
    return /* @__PURE__ */ React100.createElement(React100.Fragment, null, !mounted || !chain ? /* @__PURE__ */ React100.createElement(IsPixelWidget_default, {
      onClick: openConnectModal,
      className: "connect_connect"
    }, /* @__PURE__ */ React100.createElement("p", null, t("Connect Wallet"))) : chain && (chain.unsupported || !supportedChainIds(env, supportedChainList).includes(
      `${chain.id}`
    )) ? /* @__PURE__ */ React100.createElement(WrongNetwork_default, null) : /* @__PURE__ */ React100.createElement(rainbow_account_default, {
      copy,
      env,
      setSuccessToast,
      setErrorToast,
  ...
  }), isBigWidth ? /* @__PURE__ */ React100.createElement(Language_default, {
...
// src/components/Header/header.tsx
var Header = (props) => {
  const setSideCollapse = useSetRecoilState17(sideCollapseState);
  const collapsed = useRecoilValue16(sideCollapseState);
  const {
    hideMenu = false,
    env,
    setSuccessToast,
  ...
  return /* @__PURE__ */ React101.createElement("header", {
  ...
  }, isBingo ? null : /* @__PURE__ */ React101.createElement("div", {
    className: "header_left"
  }, /* @__PURE__ */ React101.createElement(ZypherLogo, {
    Link,
    isMobile: isW830
  })), !isW830 && !isBingo && /* @__PURE__ */ React101.createElement(Navigation_default, {
    pathname,
    Link
    ...
    CountUpNumber,
    supportedChainList
  }), isW830 && !hideMenu ? /* @__PURE__ */ React101.createElement(IsPixelWidget_default, {
    className: "header_btn_pixel"
  }, /* @__PURE__ */ React101.createElement("div", {
    className: "header_btn",
    onClick: () => setSideCollapse(!collapsed)
  }, /* @__PURE__ */ React101.createElement(icons_default, {
    className: "header_icon",
    name: "menu"
  }))) : null), /* @__PURE__ */ React101.createElement(LinkToBetaDialog_default, null));
};
...
import { useSetRecoilState as useSetRecoilState18 } from "recoil";
import { useEffect as useEffect38 } from "react";
import { ethers as ethers4 } from "ethers";
var useGetInvitationAddress = () => {
  const setInvitationAddressState = useSetRecoilState18(invitationAddressState);
  useEffect38(() => {
...
var graphqlApiUrl = {
  ...
  ["50098" /* ZytronLineaSepoliaTestnet */]: "https://zytron-linea-testnet-graph.zypher.game/subgraphs/name/zytron/bingo",
...
import { useEffect as useEffect40, useRef as useRef13 } from "react";
...
// src/contract/getBingoConfig.ts
...
var IBingoVersion = /* @__PURE__ */ ((IBingoVersion2) => {
  IBingoVersion2["v1"] = "v1";
  IBingoVersion2["beta"] = "beta";
  IBingoVersion2["champion"] = "champion";
  return IBingoVersion2;
})(IBingoVersion || {});
var getBingoAbi = ({
  contractName,
  bingoVersion
  ...
  const abiMap = {
    ["card" /* Card */]: {
      ["champion" /* champion */]: abiChampionZkBingoCard,
      ["beta" /* beta */]: abiBetaZkBingoCard,
      ["v1" /* v1 */]: abiV1ZkBingoCard
    },
    ["lobby" /* Lobby */]: {
      ["champion" /* champion */]: abiChampionZkBingoLobby,
      ["beta" /* beta */]: abiBetaZkBingoLobby,
      ["v1" /* v1 */]: abiV1ZkBingoLobby
    },
    ["Monster" /* Monster */]: {
      ["v1" /* v1 */]: abiMonsterSlayer202310
    },
    ["ZkBingoFee" /* Fee */]: {
      ["champion" /* champion */]: abiZkBingoChampionFee,
      ["v1" /* v1 */]: abiZkBingoV1Fee
    }
  };
  ...
  return versionMap[bingoVersion] || versionMap["v1" /* v1 */];
};
var getBingoConfig = ({
  contractName,
  bingoVersion,
  ...
  if (bingoVersion === "champion" /* champion */) {
    return [bingoAbi, zkBingoChampion(chainId, contractName)];
  }
  if (bingoVersion === "beta" /* beta */) {
...
export {
  rainbow_account_default as Account,
  ActivePixelButton,
  ...
  TokenWithChain_default as TokenWithChain,
  ...
  useRecoilState17 as useRecoilState,
